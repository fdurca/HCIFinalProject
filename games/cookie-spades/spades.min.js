!function r(s, o, l) {
          ...
          , i = {
            ...
            numberedGames: {
                win: function(e, t, a, i, n) {
                    ...
                    o("/api/" + t + "/" + a + "/numberedgames/" + e + "/win", i, n)
                },
                postSaveResult: function(e, t, a, i, n, r) {
                    return i = i.replace(/ /g, "-"),
                    o("/api/" + a + "/" + i + "/numberedgames/" + t + "/saveresult", e, n, r)
                },
                start: function(e, t, a, i, n) {
                    return a = a.replace(/ /g, "-"),
                    o("/api/" + t + "/" + a + "/numberedgames/" + e + "/start", i, n)
                },
                getGame: function(e, t, a, i, n) {
                    return a = a.replace(/ /g, "-"),
                    s("/api/" + t + "/" + a + "/numberedgames/" + e + "/?domain=" + encodeURIComponent(location.href), i, n)
                },
                getStats: function(e, t, a, i) {
                    return t = t.replace(/ /g, "-"),
                    s("/api/" + e + "/" + t + "//numberedgames/stats", a, i)
                }
            },
            visitors: {
                post: function(e, t, a) {
    ...
    2: [function(e, t, a) {
        ...
        var i = function() {
            function e(e, t) {
                ...
                i[t] ? (this.longName = i[t] + " of " + a[e] + "s",
                this[i[t]] = !0) : this.longName = t + " of " + a[e] + "s",
        ...
        var i = e("../helper-functions")
          ...
          , s = function() {
            ...
            t.initDefaultRenderers = function() {
                ...
                this.renderers.win = this.makeRenderFunc("startagain"),
                this.renderers.sorthand = this.makeRenderFunc("sorthand - @player.name - @player.hand"),
                this.renderers.illegalcard = this.makeRenderFunc("illegalcard - @player.name - @card"),
                this.renderers.pickdealer = this.makeRenderFunc("pickdealer - @player.name"),
                this.renderers.forcequit = this.makeRenderFunc("forcequit - @player.name forcequits the game - @reason")
            }
            ,
            t.message = function() {}
            ,
            t.renderEvent = function(e, t, a) {
                (a = a || {}).player || (a.player = this.currentPlayer()),
                a.name = e;
                var i = a.game = this;
            ...
            t.playCards = function(e, t) {
                ...
                for (a = i ? a : a[Symbol.iterator](); ; ) {
                    ...
                    if (!this.canPlayCard(e, s))
                        throw "Illegal card from " + e.name + ", " + s;
                    if (this.pile.push(s),
                    s.selected = !1,
                    !this.removeCard(e, s))
                        throw "Card " + s + " is not held by player " + e.name;
                    s.playedBy = e
                }
                e.selectedCards = [],
                e.canPlay = !1,
            ...
            t.selectCard = function(e, t, a) {
                ...
                e.selectedCards === this.undefined && (e.selectedCards = []),
                t.selected = !0,
                e.selectedCards.push(t),
                this.renderEvent("selectcard", a || function() {}
                , {
                    card: t,
                    player: e
                })
            ...
            t.unselectCard = function(e, t, a) {
                ...
                t.selected = !1,
                p.remove(e.selectedCards, t),
                this.renderEvent("unselectcard", a || function() {}
                , {
                    card: t,
                    player: e
                })
            ...
            t.unselectAllCards = function(e, t) {
                ...
                for (i = n ? i : i[Symbol.iterator](); ; ) {
                    ...
                    var o = s;
                    if (!e.hand.includes(o))
                        throw "Player can't unselect card " + o + ", it's not in his hand";
                    if (!o.selected)
                        throw "Card " + o + " is not selected"
                }
                var l = a
                  , d = Array.isArray(l)
                  , c = 0;
            ...
            t.sortHand = function(e, t, a) {
                if (e.hand) {
                    ...
                    e.hand.sort(s),
                    e.hand.toString() === n && this.canSortDesc && (r = function(e, t) {
                        return t - e
                    }
                    ,
                    e.hand.sort(s)),
                    a || this.renderEvent("sorthand", t || function() {}
                    , {
                        player: e
                    })
                }
            ...
            t.playerPlay = function() {
                ...
                0 === t.length)
                    ...
                    this.currentPlayer().play(t);
            }
            ,
            t.nextPlayerTurn = function() {
                var e = this.currentPlayer();
                this.hasWon(e) ? ("bottom-player" === e.id ? this.message("You win!") : this.message(e.name + " wins!"),
                this.renderEvent("win", function() {})) : (this.currentPlayerIndex = this.pickNextPlayerIndex(),
            ...
            t.forceQuit = function(e, t) {
                var a, i, n, r = this.players, s = r[0], o = r[1];
                e === s ? (a = o,
                i = s,
                "concede" === t ? n = "You concede, " + o.name + " wins the game!" : "timeout" === t ? n = "You timed out, " + o.name + " wins the game!" : "abandon" === t && (n = "You disconnected, " + o.name + " wins the game!")) : ("concede" === t ? n = o.name + " concedes the game, you win!" : "timeout" === t || "localtimeout" === t ? n = o.name + " timed out, you win the game!" : "abandon" === t && (n = o.name + " disconnected, you win the game!"),
                a = s,
                i = o),
                this.message(n),
                this.renderEvent("forcequit", function() {
            ...
            t.startAgain = function() {
                ...
                for (e = t ? e : e[Symbol.iterator](); ; ) {
                    ...
                    n.hand && (n.hand = []),
                    n.tricks && (n.tricks = []),
                    n.showCards && "bottom-player" !== n.id && delete n.showCards,
                    n.selectedCards && (n.selectedCards = []),
                    n.points && (n.points = 0),
                    n.results && (n.results = []),
                    n.stats = {}
                }
                ...
                this.pickDealer(r),
                this.beforeNewRound && this.beforeNewRound(),
                this.renderEvent("startagain", this.start)
            }
            ,
            t.pickDealer = function(e) {
                0 <= this.lastDealerIndex ? this.dealerIndex = (this.lastDealerIndex + 1) % e.length : this.dealerIndex = Math.floor(Math.random() * e.length),
                this.nextPlayerToDealTo = (this.dealerIndex + 1) % e.length,
            ...
            t.newDeck = function(e) {
                ...
                for (var a = 12 + t, i = t; i <= a; i++)
                    this.deck.push(new l("h",i)),
                    this.deck.push(new l("s",i)),
                    this.deck.push(new l("d",i)),
                    this.deck.push(new l("c",i));
                if (this.allCards = this.deck.slice(),
                this.deckCode) {
            ...
            t.deal = function() {
                ...
                if (this.dealtCardCount === this.cardCount * this.players.length)
                    ...
                    if (this.fixedCards) {
                        ...
                        for (var n in this.fixedCards)
                            a(n);
                        delete this.fixedCards
                    }
                    e = this._fixed && this._fixed[t.id] && 0 < this._fixed[t.id].length ? this._fixed[t.id].pop() : this.deck.pop(),
                    t.hand.push(e),
    ...
    4: [function(e, t, a) {
        ...
        function p(e) {
            for (var t = 0, a = ["", "-webkit-", "-ms-"]; t < a.length; t++) {
                var i = a[t];
                if (void 0 !== document.body.style[i + e])
                    return i
            }
            return null
        }
        ...
        P.CARD_PADDING_PERCENTAGE = P.MAX_SIZE_CARD_PADDING / P.MAX_CARD_SIZE.width,
        jQuery.fn.moveCard = function(e, t, a, i) {
        ...
        h.prototype.move = function(e, t, a, i) {
            return $(this.guiCard).moveCard(e, t, a, i),
            this
        }
        ,
        ...
        h.prototype.rotate = function(e, t) {
            if (null !== m)
                return "number" == typeof t && null !== b ? $(this.guiCard).css(b + "transition-property", m + "transform").css(b + "transition-duration", o.ms(t) + "ms") : null !== b && $(this.guiCard).css(b + "transition-property", "").css(b + "transition-duration", ""),
                0 === e ? $(this.guiCard).css(m + "transform", "") : C ? $(this.guiCard).css(m + "transform", "rotate3d(0,0,1," + e + "deg)") : $(this.guiCard).css(m + "transform", "rotate(" + e + "deg)"),
                this
        }
        ,
        ...
        h.prototype.showCard = function(e) {
            ...
            return $(this.guiCard).addClass(t).addClass("up").removeClass([P.LEFT, P.RIGHT, P.TOP, P.BOTTOM].join(" ")).addClass(e || P.BOTTOM),
            this
        }
        ,
        h.prototype.moveToFront = function() {
            return this.guiCard.style.zIndex = v.next(),
            this
        }
        ,
        h.prototype.moveToBack = function() {
            return this.guiCard.style.zIndex = 0,
            this
        }
        ,
        h.prototype.hideCard = function(e) {
            this.normalizeRotationOnMove && this.rotate(0);
            var t = this.suit.toLowerCase() + this.rank;
            return $(this.guiCard).removeClass("up").removeClass(t).removeClass([P.LEFT, P.RIGHT, P.TOP, P.BOTTOM].join(" ")).addClass(e || P.BOTTOM),
            this
        }
        ;
        var S = function() {
            ...
            t.calculateBasicPositions = function(e) {
                if (P.TABLE_SIZE.width = $("#play-page").width(),
                k.isMobileLookActive()) {
                    g.debug("CalculateBasicPositions: mobile look active"),
                    this.setBoardHeight(),
                    P.CONDENSE_COUNT = 8,
                    P.OVERLAY_MARGIN = 1;
                    var t = 24;
                    ...
                    P.TABLE_SIZE.height < 450 ? (P.CARD_SIZE.width = 52,
                    P.CARD_SIZE.height = this.getCardHeight(P.CARD_SIZE.width)) : (P.CARD_SIZE.width = P.MAX_CARD_SIZE.width,
                    P.CARD_SIZE.height = P.MAX_CARD_SIZE.height),
                    375 <= P.TABLE_SIZE.width && (t = 39),
                    P.DECK_AND_PILE_SIZE.width = P.CARD_SIZE.width,
                    P.DECK_AND_PILE_SIZE.height = P.CARD_SIZE.height;
                    ...
                    P.RIGHT_PLAYER_LEFT = P.TABLE_SIZE.width - P.LEFT_PLAYER_LEFT - a,
                    P.BOTTOM_PLAYER_LEFT = P.TOP_PLAYER_LEFT = Math.floor(P.TABLE_SIZE.width / 2),
                    P.BOTTOM_PLAYER_TOP = P.TABLE_SIZE.height - i - P.CARD_SIZE.height - 5,
                    P.TOP_PLAYER_TOP = i + 3,
                    $("#messageBox").css("top", Math.floor(P.BOTTOM_PLAYER_TOP - $("#messageBox").height() - 4));
                    ...
                    g.debug("CalculateBasicPositions: desktop look active"),
                    P.CONDENSE_COUNT = 6,
                    P.OVERLAY_MARGIN = 1,
                    this.setBoardHeight(),
                    ...
                    P.BOTTOM_PLAYER_TOP = P.TABLE_SIZE.height - P.CARD_SIZE.height - P.VERTICAL_MARGIN,
                    P.TOP_PLAYER_TOP = P.VERTICAL_MARGIN,
                    P.LEFT_PLAYER_TOP = P.TABLE_SIZE.height / 2,
                    P.RIGHT_PLAYER_TOP = P.TABLE_SIZE.height / 2,
                    P.BOTTOM_PLAYER_LEFT = P.TABLE_SIZE.width / 2,
                    P.TOP_PLAYER_LEFT = P.TABLE_SIZE.width / 2,
                    P.LEFT_PLAYER_LEFT = P.HORIZONTAL_MARGIN,
                    P.RIGHT_PLAYER_LEFT = P.TABLE_SIZE.width - P.CARD_SIZE.height - P.HORIZONTAL_MARGIN,
                    P.DECK_POS = {
                ...
                var h = Math.round((P.TABLE_SIZE.width - P.CARD_SIZE.width) / 2)
                  ...
                  , m = 40
                  , f = 35;
                P.CARD_SIZE.width < P.MAX_CARD_SIZE.width && (m = 30,
                f = 26),
                P.TRICK_POS = {
                    top: {
                        top: p - f,
            ...
            t.resize = function(e, t) {
                ...
                if (t) {
                    ...
                    var i = e.game
                      , n = i.players;
                    if (0 < n.length && (p(n[0], P.BOTTOM_PLAYER_CARD_SIZE, P.BOTTOM_PLAYER_TOP, P.BOTTOM_PLAYER_LEFT),
                    this.resizeTricks(n[0]),
                    this.adjustHand(n[0], null, 50)),
                    2 === n.length ? (p(n[1], P.TOP_PLAYER_CARD_SIZE, P.TOP_PLAYER_TOP, P.TOP_PLAYER_LEFT),
                    this.resizeTricks(n[1]),
                    this.adjustHand(n[1], null, 50)) : 3 <= n.length && (p(n[1], P.LEFT_PLAYER_CARD_SIZE, P.LEFT_PLAYER_TOP, P.LEFT_PLAYER_LEFT),
                    p(n[2], P.TOP_PLAYER_CARD_SIZE, P.TOP_PLAYER_TOP, P.TOP_PLAYER_LEFT),
                    this.resizeTricks(n[1]),
                    this.resizeTricks(n[2]),
                    this.adjustHand(n[1], null, 50),
                    this.adjustHand(n[2], null, 50)),
                    4 === n.length && (p(n[3], P.RIGHT_PLAYER_CARD_SIZE, P.RIGHT_PLAYER_TOP, P.RIGHT_PLAYER_LEFT),
                    this.resizeTricks(n[3]),
                    this.adjustHand(n[3], null, 50)),
                    0 === i.players.length && (p(e.bottomPlayer, P.BOTTOM_PLAYER_CARD_SIZE, P.BOTTOM_PLAYER_TOP, P.BOTTOM_PLAYER_LEFT),
                    p(e.leftPlayer, P.LEFT_PLAYER_CARD_SIZE, P.LEFT_PLAYER_TOP, P.LEFT_PLAYER_LEFT),
                    p(e.topPlayer, P.TOP_PLAYER_CARD_SIZE, P.TOP_PLAYER_TOP, P.TOP_PLAYER_LEFT),
                    p(e.rightPlayer, P.RIGHT_PLAYER_CARD_SIZE, P.RIGHT_PLAYER_TOP, P.RIGHT_PLAYER_LEFT)),
                    this.resizeCustom && this.resizeCustom(e),
                    this.resizeDeckAndPile(i),
                    "trick" === this.playType && i.pile && 0 < i.pile.length) {
                        var r = i.pile
                          , s = Array.isArray(r)
                          , o = 0;
            ...
            t.resizeDeckAndPile = function(e) {
                function t(e, t, a, i) {
                    for (var n = 0; n < e.length; n++) {
                        var r = e[n];
                        (n + 1) % P.CONDENSE_COUNT == 0 && (a -= P.OVERLAY_MARGIN,
                        t -= P.OVERLAY_MARGIN),
                        $(r.guiCard).css({
                            top: t,
                            left: a,
                ...
                e.deck && 0 < e.deck.length && t(e.deck, P.DECK_POS.top, P.DECK_POS.left, P.DECK_AND_PILE_SIZE),
                e.pile && 0 < e.pile.length && "pile" === this.playType && t(e.pile, P.PILE_POS.top, P.PILE_POS.left, P.DECK_AND_PILE_SIZE)
            }
            ,
            ...
            t.deckReady = function(e) {
                this._createCardPile(e.game.deck, P.DECK_POS.top, P.DECK_POS.left, !1),
                e.callback(),
                c.get("autodeal", !1) && (c.remove("autodeal"),
                $("#deal").click())
            }
            ,
            t.clearTable = function(e) {
                ...
                k.cake("results") || c.get("scores") ? e.game.message("Click Deal to start the next round.") : e.game.message("Click Deal to start a new game."),
                l.resetGameStatus(),
                this.clearTableCustom && this.clearTableCustom(e),
                e.callback()
            }
            ,
            ...
            t._createCardPile = function(e, t, a, i) {
                ...
                k.qs.cards && (s = k.qs.cards);
                var o = "cards" + s + "x.css";
                $("#csscards").attr("href") !== o && ($("#csscards").remove(),
                $("<link>", {
                    rel: "stylesheet",
                    id: "csscards",
                    href: "cards.css"
            ...
            t.getCardPos = function(e, t, a) {
                ...
                var i = P.CARD_SIZE.height
                  ...
                  , r = P.CARD_PADDING
                  , s = 15;
                e.cardSize && (i = e.cardSize.height,
                n = e.cardSize.width,
                ...
                if (e.position === P.BOTTOM && (k.siteSettings.spreadCards || k.isMobileLookActive())) {
                    var p = a - 1;
                    o = u,
                    r = Math.floor((o - P.CARD_SIZE.width) / p),
                    h = o - (P.CARD_SIZE.width + p * r),
                    r > P.CARD_SIZE.width / 2 && (r = Math.ceil(P.CARD_SIZE.width / 2),
                    o = P.CARD_SIZE.width + p * r,
                    h = 0)
                } else if (e.position !== P.BOTTOM) {
                    var m = n + 12 * r;
                    if (m < o)
                        h = (o = m) - (n + (a - 1) * (r = Math.floor((m - n) / (a - 1))))
                }
                var f = (i - n) / 2;
                if (e.position === P.TOP) {
                    var g = e.left + o / 2 - n;
                    ...
                    var y = e.left - o / 2;
                    (o - n) / (a - 1) < Math.round(P.MAX_SIZE_CARD_PADDING / P.MAX_CARD_SIZE.width * n) ? this.adjustCrushedCards(e, l, n, o, y, a, t) : (t <= h ? r++ : y += h,
                    l.left = y + t * r),
                    l.top = e.top - d
            ...
            t.adjustCrushedCards = function(e, t, a, i, n, r, s) {
                ...
                for (var l = Math.round(P.MAX_SIZE_CARD_PADDING / P.MAX_CARD_SIZE.width * a), d = Math.round(P.MAX_SIZE_CARD_PADDING / P.MAX_CARD_SIZE.width * a * 1.5), c = Math.ceil(l / 2), u = 7, h = 320; h + d < P.TABLE_SIZE.width; )
                    u++,
                    h += d;
                function p(e) {
                ...
                m < 2 && (m = 0),
                r - 2 <= m + u && (m = r - u - 1);
                var f, g = m + u, y = m, v = p(y), b = r - g, k = i - v - (p(b - 1) + a), w = k - (0 == b ? (u - 1) * (f = Math.floor((k - a) / (u - 1))) + a : u * (f = Math.floor(k / u)));
                if (s < m) {
                    t.left = n + 2 * s;
                    var C = y - 2
                      , S = 2 * C;
                    ...
                    var $ = s - y
                      , E = n + v;
                    t.left = $ < w ? E + $ * (f + 1) : E + $ * f + w,
                    t.crushed = !1
                } else {
                    var A = s - y - u
                      , I = n + v + k;
                    t.left = A < 2 ? I + A * c : I + 2 * c + 2 * (A - 2),
                    t.crushed = !0,
                    t.crushed = 0 != A
                }
            }
            ...
            t.pickDealer = function(e) {
                ...
                e.game.showDealerHat && $("#" + e.dealerId).addClass("dealer"),
                e.callback()
            }
            ,
            t.pass = function(e) {
                ...
                t.css("width", "100px"),
                a.width = P.TABLE_SIZE.width) : (t.css("width", P.TABLE_SIZE.width + "px"),
                t.css("text-align", "center")),
                t.show().animate(a, 2 * y.ANIMATION_SPEED).fadeOut(y.ANIMATION_SPEED, e.callback)
            }
            ,
            t.play = function(e) {
                ...
                function h(e) {
                    if (0 === u.cards.length)
                        ...
                        for (var o = t.length - 1; 0 <= o; o--)
                            $(t[o].guiCard).css("z-index", v.value + o + 1);
                        v.value += t.length + 3;
                        var l = u.cards[0];
                        ...
                        0 === u.cards.length && p.adjustHand(u.player, null, y.ANIMATION_SPEED, !0),
                        p.showCards([l])
                    }
                }
                var p = this
            ...
            t.playOnTrick = function(e) {
                ...
                t.push(e.cards[0]),
                this.moveCardsToFront(t);
                var a = e.player.position
                  , i = P.TRICK_POS[a]
                  , n = e.cards[0];
                n.random && e.game.message(e.player.name + " waited too long to make their move, a random card was played for them!"),
                $(n.guiCard).moveCard(i.top, i.left, e.callback),
                this.showCards([n]),
                d(function() {
                    return n.moveToFront()
                }, y.ANIMATION_SPEED / 1.5),
                this.adjustHand(e.player, null, y.ANIMATION_SPEED, !0)
            }
            ,
            t.adjustHand = function(e, t, a, i, n) {
                ...
                for (var r = 0; r < e.hand.length; r++) {
                    ...
                    e.cardSize ? $(s.guiCard).moveAndSizeCard(o.top, o.left, e.cardSize.width, e.cardSize.height, l, a) : $(s.guiCard).moveCard(o.top, o.left, l, a),
                    s.crushed = !!o.crushed,
                    i || s.moveToFront()
                }
                0 === e.hand.length && t && d(t, a),
                e.showCards ? this.showCards(e.hand, e.position, a / 2) : this.hideCards(e.hand, e.position, a / 2)
            }
            ,
            t.draw = function(e) {
            ...
            t.showResults = function() {
                ...
                t -= 22,
                k.isMobileLookActive() && 25 < t && (t -= 25),
                $("#result-box").css("z-index", Math.max(5e5, v.next())),
                $("#result-box").css("top", Math.max(Math.floor(t), 0))
            }
            ,
            ...
            t.getTrickProps = function(e, t) {
                ...
                var d = $("#left-player").offset().top - $("#play-page").offset().top
                  , c = 5;
                if (e.position === P.TOP || e.position === P.BOTTOM ? (a.width = P.TRICK_SIZE.width,
                a.height = P.TRICK_SIZE.height) : (a.width = P.TRICK_SIZE.height,
                a.height = P.TRICK_SIZE.width),
                e.position === P.TOP)
                    k.isMobileLookActive() && (c -= 3),
                    a.top = r,
                    a.left = s + o + c + l;
                else if (e.position === P.BOTTOM) {
                    var u = P.TABLE_SIZE.height - parseInt($("#bottom-player").css("bottom")) - $("#bottom-player").height();
                    a.top = u + (n - P.TRICK_SIZE.height) / 2,
                    k.isMobileLookActive() && (c += 3),
                    a.left = s - o - P.TRICK_SIZE.width - c - l
                } else if (e.position === P.LEFT)
                    a.top = d - P.TRICK_SIZE.width - c - l,
                    a.left = 1 + r;
                else if (e.position === P.RIGHT) {
                    var h = k.isMobileLookActive() ? 0 : 2;
                    a.left = P.TABLE_SIZE.width - r - P.TRICK_SIZE.height - h,
                    k.isMobileLookActive() ? a.top = d - P.TRICK_SIZE.width - c - l : a.top = d + $("#right-player").height() + c + l
                }
                for (var p in a)
                    a[p] = Math.round(a[p]);
                return a
            ...
            t.getTrickCountProps = function(e, t) {
                var a = {};
                return e.position === P.TOP ? (a.top = t.top,
                a.left = t.left + P.TRICK_SIZE.width) : e.position === P.BOTTOM ? (a.top = t.top,
                a.left = t.left - $("#bottom-player-trick-count").width()) : e.position === P.LEFT ? (a.top = t.top - $("#left-player-trick-count").height(),
                a.left = t.left) : e.position === P.RIGHT && (a.left = t.left,
                k.isMobileLookActive() ? a.top = t.top - $("#right-player-trick-count").height() : a.top = t.top + P.TRICK_SIZE.width),
                a
            }
            ,
            t.takeTrick = function(h) {
                ...
                d(function() {
                    ...
                    function d() {
                        $(".trick-card").hide();
                        var e = $("<div/>");
                        h.player.tricks[h.player.tricks.length - 1].element = e.get(0),
                        $("#play-page").append(e.addClass("trick").addClass(h.player.position).addClass(l).css(r)),
                        h.callback()
                    }
                    for (var c = 0; c < h.trick.length; c++)
                        $(h.trick[c].guiCard).animate(s, y.ANIMATION_SPEED, c === h.trick.length - 1 ? d : null);
                    ...
                    u.animate(o, y.ANIMATION_SPEED, function() {
                        if (void 0 !== h.player.bidValue) {
                            ...
                            u.text(h.player.tricks.length.toString())
                    })
                }, y.TAKE_TRICK_DELAY)
            }
            ,
        ...
        var i = e("./render")
          ...
          , E = function() {
            ...
            return t.init = function(e, t, a, i) {
                ...
                try {
                    if (y.qs.gid) {
                        ...
                        r && (this.multiplayerTable = r,
                        this.game.isPrivateGame = this.multiplayerTable.isPrivate,
                        this.tempStorage.remove(y.qs.gid),
                        $("#messageBox").show(),
                    ...
                    this.renderer.calculateBasicPositions(this.game),
                    this.createHumanPlayer(e),
                    this.createOpponentPlayers(t, i),
                    ...
                    "Click Deal to start the game." === $("#messageBox p").text() && $("html").hasClass("starwars") && $("#messageBox p").text("To start the game, click Deal you must!"),
                    this.setupPlayerCountHandler(),
                    this.setupRestartHandler(),
                    this.setupWinHandler(),
                    this.setupStartHandler(),
                    this.setupTurnHandler(),
                    this.multiplayerTable && 1 === this.multiplayerTable.round && (y.deleteCake("results"),
                    this.tempStorage.remove("scores"),
                    this.tempStorage.remove("results")),
                    this.setupMultiplayerLobby(),
                    this.extraSetup(),
                    this.multiplayerTable ? this.setupMultiplayerGame() : this.setupDealHandler(),
                    this.startGame(),
                    g.addRestartHandler(function() {
                        return n.restartWithoutReload()
                    }),
                    $(window).on("resize", function(e) {
                        e.game = n.game,
                        e.topPlayer = n.topPlayer,
                        e.bottomPlayer = n.bottomPlayer,
                        e.human = n.bottomPlayer,
                        e.rightPlayer = n.rightPlayer,
                        e.leftPlayer = n.leftPlayer,
                        n.renderer.resize(e)
                    }),
            ...
            t.createHumanPlayer = function(e) {
                this.human = new e(v.bottom.name),
                this.human.top = p.BOTTOM_PLAYER_TOP,
                this.human.left = p.BOTTOM_PLAYER_LEFT,
                this.human.position = p.BOTTOM,
                this.human.showCards = !0,
                this.human.id = "bottom-player",
                this.human.stats = {},
                this.bottomPlayer = this.human,
                this.multiplayerTable && (this.human.multiplayerId = this.multiplayerTable.players[0].id)
            }
            ,
            t.restartWithoutReload = function() {
                y.deleteCake("results"),
                this.tempStorage.remove("scores"),
            ...
            t.saveLastDealer = function() {
                this.multiplayerTable || (this.tempStorage.set("lastdealerindex", this.game.dealerIndex),
            ...
            t.createOpponentPlayers = function(e, t) {
                if (this.multiplayerTable) {
                    this.topPlayer = this.createPlayer(t, S),
                    this.leftPlayer = this.createPlayer(t, C),
                    this.rightPlayer = this.createPlayer(t, T),
                    this.topPlayer.face = v.top.code;
                    var a = this.multiplayerTable.players;
                    2 === a.length ? this.topPlayer.multiplayerId = a[1].id : 3 === a.length ? (this.leftPlayer.multiplayerId = a[1].id,
                    this.topPlayer.multiplayerId = a[2].id) : 4 === a.length && (this.leftPlayer.multiplayerId = a[1].id,
                    this.topPlayer.multiplayerId = a[2].id,
                    this.rightPlayer.multiplayerId = a[3].id)
                } else
                    this.topPlayer = this.createPlayer(e, S),
                    this.leftPlayer = this.createPlayer(e, C),
                    this.rightPlayer = this.createPlayer(e, T)
            }
            ,
            t.createPlayer = function(e, t, a) {
                ...
                void 0 === a && (a = !1);
                var i = {};
                i[S] = [v.top.name, "top-player", p.TOP_PLAYER_TOP, p.TOP_PLAYER_LEFT, p.TOP, p.TOP_PLAYER_CARD_SIZE, v.top.code],
                i[C] = [v.left.name, "left-player", p.LEFT_PLAYER_TOP, p.LEFT_PLAYER_LEFT, p.LEFT, p.LEFT_PLAYER_CARD_SIZE, v.left.code],
                i[T] = [v.right.name, "right-player", p.RIGHT_PLAYER_TOP, p.RIGHT_PLAYER_LEFT, p.RIGHT, p.RIGHT_PLAYER_CARD_SIZE, v.right.code],
                i[w] = [v.bottom.name, "bottom-player", p.BOTTOM_PLAYER_TOP, p.BOTTOM_PLAYER_LEFT, p.BOTTOM, p.BOTTOM_PLAYER_CARD_SIZE, v.bottom.code];
                var n = i[t]
                  , r = n[0]
                  , s = n[1]
                  , o = n[2]
            ...
            t.setupSortHandler = function() {
                ...
                $("#sortHand").on("click touchstart", function(e) {
                    e.preventDefault(),
                    t.human.canPlay || t.human.mustDraw ? t.game.sortHand(t.human, function() {}) : t.game.message("You can only sort when it is your turn to play.")
                })
            }
            ,
            t.setupPlayerCountHandler = function() {
                this.game.canChangePlayerCount && (this.playerCount = y.settings.playerCount),
                this.multiplayerTable && (this.playerCount = this.multiplayerTable.players.length),
                2 < this.playerCount && $("#left-player").show(),
                4 === this.playerCount && $("#right-player").show(),
                $("#player-count-" + this.playerCount).addClass("selected");
                var a = this;
                $("#player-count button").on("click touchstart", function(e) {
                    e.preventDefault();
                    var t = parseInt($(this).data("value"));
                    a.playerCount = t,
                    y.settings.set("playerCount", a.playerCount),
                    a.pickDealer(),
                    $("#player-count button").removeClass("selected"),
                    $(this).addClass("selected"),
                    4 === a.playerCount && ($("#right-player").fadeIn(),
                    $("#left-player").fadeIn()),
                    3 === a.playerCount && ($("#right-player").fadeOut(),
                    $("#left-player").fadeIn()),
                    2 === a.playerCount && ($("#right-player").fadeOut(),
                    $("#left-player").fadeOut())
                })
            }
            ,
            t.bindCardEventHandlers = function() {
                ...
                $(".card").on("mousedown touchstart", function(e) {
                    ...
                    function(e) {
                        if (e.crushed && a && a.hand) {
                            ...
                            return -1 !== t && (a.zoomedPos = t,
                            i.adjustHand(a, null, n.ANIMATION_SPEED),
                            !0)
                        }
                        return !1
                ...
                document.addEventListener("keydown", function(e) {
                    if (e.keyCode === 13 && a.activeCard) {
                        a.dehoverCard(a.activeCard);
                        a.useCard(a.activeCard);
                        a.activeCard = null;
                    }else if (e.keyCode === 37) {
                        if (!a.activeCard){
                            a.hoverCard(a.hand[0]);
                            a.activeCard = a.hand[0];
                        } else {
                            if (a.hand.indexOf(a.activeCard) != 0){
                                a.dehoverCard(a.activeCard);
                                a.hoverCard(a.hand[a.hand.indexOf(a.activeCard) - 1]);
                                a.activeCard = a.hand[a.hand.indexOf(a.activeCard) - 1];
                            }
                        }
                    } else if (e.keyCode === 39) {
                        if (!a.activeCard){
                            a.hoverCard(a.hand[a.hand.length-1]);
                            a.activeCard = a.hand[a.hand.length-1];
                        } else {
                            if (a.hand.indexOf(a.activeCard) != a.hand.length-1){
                                a.dehoverCard(a.activeCard);
                                a.hoverCard(a.hand[a.hand.indexOf(a.activeCard) + 1]);
                                a.activeCard = a.hand[a.hand.indexOf(a.activeCard) + 1];
                            }
            ...
            t.setupStartHandler = function() {
                ...
                this.game.setEventRenderer("start", function(e) {
                    ...
                    t.renderer.start ? t.renderer.start(e) : e.callback()
                })
            }
            ,
            t.multiplayerStartupMessage = function() {
                2 === this.game.players.length ? this.game.message("Waiting for " + v.top.name + " to come online...") : this.game.message("Waiting for other players to come online...")
            }
            ,
            ...
            t.setupMultiplayerGame = function() {
                ...
                this.preloadImages(),
                this.addPlayers(),
                $(".face-top-player, .face-right-player, .face-left-player").addClass("offline");
                ...
                for (r = o ? r : r[Symbol.iterator](); ; ) {
                    ...
                    var c = d;
                    $(".face-" + c.pos + "-player").addClass("p-" + c.id),
                    c.bot && $(".face-" + c.pos + "-player").addClass("bot")
                }

                this.multiplayerStartupMessage(),
                $("#open-player-picker").hide(),
                $("#player-count").hide(),
                this.client = new k(b,this.multiplayerTable,this.game.players),
                this.client.on("players-ready", function() {
                    2 === s.game.players.length ? s.game.message("Both players are ready, starting the game...") : s.game.message("All players are ready, starting the game..."),
                    2 === s.multiplayerTable.playerCount.maxPlayers ? m.startMultiplayerChallengeGame(s.game.players[1]) : m.startGame(s.game.players),
                    s.beforeMultiplayerDeal(),
                    s.game.deal(),
                    g.startGame(),
                    y.isMobileLookActive() && $("#messageBox").fadeIn()
                }),
                this.client.on("forcequit", function(e) {
                    s.game.forceQuit(e.data.player, e.data.reason)
                }),
                $(".multiplayer-start-next-round").attr("disabled", "disabled"),
                ...
                function u(n) {
                    ...
                    s.game.renderers[n] = function(e) {
                        var t = !1;
                        if (e.player.shouldMakeSubstituteMove && (t = e.player.shouldMakeSubstituteMove()),
                        "bottom-player" === e.player.id || t) {
                            var a = s.multiplayerEventTransforms[n];
                            if (a) {
                                var i = a(e);
                                i ? (t ? (f.debug("Making substitute move for " + e.player.name),
                                i.playerId = e.player.multiplayerId,
                                i.substitute = !0) : i.playerId = s.human.multiplayerId,
                                s.client.sendMove(i)) : f.debug("Transform returned null for event " + n + ", not sending it")
                            }
                        } else
                            f.debug("Not Bottom player");
                        r(e)
                    }
                }
                for (var h in this.game.renderers)
                    u(h)
            }
            ,
            ...
            t.setupMultiplayerLobby = function() {
                if (2 === this.game.defaultPlayerCount) {
                    ...
                    e && h("privateroom", e, 1),
                    this.lobbyClient = new c(b,e)
                } else {
                    var t = {
                        maxPlayers: this.game.defaultPlayerCount
                    };
                    this.game.canChangePlayerCount ? t.minPlayers = 2 : t.minPlayers = t.maxPlayers,
                    this.lobbyClient = new d(b,t)
                }
            }
            ,
            t.setupTurnHandler = function() {
                this.game.setEventRenderer("playerturn", function(e) {
                    "bottom-player" === e.player.id ? e.game.message("Your turn!") : e.game.message(e.player.name + "'s turn!"),
                    e.callback()
                })
            }
            ,
            t.preloadImages = function() {
                ...
                2 <= window.devicePixelRatio && (y.preloadImage(STATIC_ASSET_DOMAIN + "/shared/images/cards/vertical-trick2x.png"),
                y.preloadImage(STATIC_ASSET_DOMAIN + "/shared/images/cards/horizontal-trick2x.png"))
            }
            ,
            t.addPlayers = function() {
                this.multiplayerTable && (this.playerCount = this.multiplayerTable.players.length,
                4 === this.playerCount && ($("#left-player").fadeIn(),
                $("#right-player").fadeIn()),
                3 === this.playerCount && ($("#left-player").fadeIn(),
                $("#right-player").fadeOut()),
                2 === this.playerCount && ($("#left-player").fadeOut(),
                $("#right-player").fadeOut())),
                this.game.addPlayer(this.human),
                2 < this.playerCount && this.game.addPlayer(this.leftPlayer),
                this.game.addPlayer(this.topPlayer),
                4 == this.playerCount && this.game.addPlayer(this.rightPlayer);
                var e = this.game.players
                  , t = Array.isArray(e)
                  , a = 0;
                for (e = t ? e : e[Symbol.iterator](); ; ) {
            ...
            t.setupDealHandler = function() {
                ...
                $("#deal").on("click touchstart", function(e) {
                    ...
                    g.startGame(),
                    0 === a.players.length && t.preloadImages(),
                    (2 !== a.defaultPlayerCount || y.siteSettings.hideMultiplayerButton) && $("#multiplayer-button").is(":visible") && $("#multiplayer-button").fadeOut(); 0 < a.players.length; )
                        a.players.pop();
                    t.addPlayers(),
                    m.startGame(a.players),
                    a.message(""),
                    t.setTestCards(),
                    a.deal(),
                    $("#deal").hide(),
                    ...
                    $("#open-player-picker").hide(),
                    $("#player-count").hide(),
                    y.trackEvent("StartGame", t.playerCount + " players", t.playerCount)
                })
            }
            ,
            t.setupRestartHandler = function() {
                ...
                $("#start-new-game").on("click touchstart", function(e) {
                    if ("disabled" !== $("#start-new-game").attr("disabled")) {
                        var t = $(this).text();
                        "Play another hand" !== t && "Play next round" !== t || n.set("autodeal", !0),
                        e.preventDefault(),
                        y.ads.trigger(function() {
                            if (y.isMobileLookActive() && !i)
                                a.startAgain();
                            else {
                                try {
                                    if (y.qs.gid && !n.get(y.qs.gid))
                                        return void (location.href = location.pathname)
                                } catch (e) {}
                                y.reloadPage()
                            }
                        })
            ...
            t.setupWinHandler = function() {
                ...
                this.game.setEventRenderer("win", function(l) {
                    var d = l.game;
                    r.multiplayerTable || (y.trackEvent("Win", l.player.id),
                    y.trackEvent("FinishGame")),
                    r.client && (r.client.sendResult({
                        finished: !0,
                        winners: [l.player.multiplayerId],
                        endReason: l.winType
                    }),
                    r.tempStorage.remove(y.qs.gid)),
                    g.finishGame(),
                    u([l.player.id]),
                    s.next(),
                    "bottom-player" === l.player.id ? $("#result-box h3").text("CONGRATULATIONS!!! YOU WIN!") : $("#result-box h3").text(l.player.name.toUpperCase() + " WINS!!!"),
                    r.setWinReason(l);
                    var e = d.players
                      , t = Array.isArray(e)
                      , a = 0;
                    ...
                    r.multiplayerTable && 2 === r.multiplayerTable.playerCount.maxPlayers ? m.finishMultiplayerChallengeGame(d.players) : m.finishGame(d.players),
                    o(function() {
                        var e = d.pile
                          , t = Array.isArray(e)
                          , a = 0;
                        ...
                        $("#result-box span#" + l.player.id + "-win").css({
            ...
            t.startGame = function() {
                this.pickDealer(),
                this.multiplayerTable && (this.game.deckCode = this.multiplayerTable.initialDeck),
                this.game.start()
            }
            ,
            t.pickDealer = function() {
                var e, t = this, a = this.playerCount || this.game.defaultPlayerCount;
                if (e = 2 == a ? ["bottom-player", "top-player"] : 3 == a ? ["bottom-player", "left-player", "top-player"] : ["bottom-player", "left-player", "top-player", "right-player"],
                this.multiplayerTable) {
                    ...
                    --n < 0 && (n = this.multiplayerTable.players.length - 1),
                    this.game.lastDealerIndex = n
                }
    ...
    6: [function(e, t, a) {
        "use strict";
        var i, l = e("./util"), n = e("./helper-functions"), o = n.captainsLog, d = n._setTimeout, r = n._setInterval, c = (n.ArrayUtils,
        l.settings), u = e("./gamecontrol"), h = e("./temp-storage"), s = {
            h: "&hearts;",
            s: "&spades;",
            d: "&diams;",
            c: "&clubs;"
        ...
        function v(e, a) {
            ...
            $.fn[e] = function() {
                var e = Array.prototype.slice.call(arguments)
                  , t = e[a];
                return "number" == typeof t ? e[a] = y(t) : t && t.duration && (t.duration = y(t.duration)),
                i.apply(this, e)
            }
        }
        function b(e) {
        ...
        $(function() {
            ...
            function n(e) {
                ...
                return void 0 === t[e] ? (o.error("Bad option name: " + e),
                {}) : t
            }
            $(document).on("keypress", function(e) {
            ...
            $('a[href="#newgame"]').click(function(e) {
                ...
                return a ? i ? l.cake("results") || r.get("scores") ? confirm(n) && (l.cake("results", ""),
                r.remove("scores"),
                l.trackEvent("NewGame", "Finished"),
                l.ads.trigger(t)) : (l.trackEvent("NewGame", "Finished"),
                l.ads.trigger(t)) : confirm(n) && (l.trackEvent("NewGame", "Abandoned"),
                l.cake("results") && l.cake("results", ""),
                r.remove("scores"),
                l.ads.trigger(t)) : l.cake("results") || r.get("scores") ? confirm(n) && (l.cake("results", ""),
                r.remove("scores"),
            ...
            function r() {
                ...
                $("#pause-notification").hide()) : u.isGameFinished() || (window.pauseTime = window.pauseTime || 0,
            ...
            i(l.cake("betacode")) && $("#board").removeClass("beta"),
            $("#beta-screen button").on("click", function(e) {
                e.preventDefault();
                var t = $("#beta-screen input").val();
                i(t) ? ($("#board").removeClass("beta"),
        ...
        void 0 !== a && (t.exports = {
            ...
            makePlayersSad: function(e) {
                for (var t = ["top-player", "bottom-player", "left-player", "right-player"], a = 0; a < t.length; a++)
                    -1 == e.indexOf(t[a]) ? b(t[a]) : k(t[a])
            },
            makePlayerSad: b,
            makePlayerHappy: k,
            ...
            combinations: function(e, n) {
                return function e(t, a, i) {
                    if (0 !== t.length || 0 !== a.length)
                        return 0 === a.length ? n ? t.length >= n && i.push(t) : i.push(t) : (e(t.concat(a[0]), a.slice(1, a.length), i),
                        e(t, a.slice(1, a.length), i)),
                        i
                }([], e, [])
            }
        })
        ...
        var l = e("../util")
          ...
          , p = function() {
            function e(e, t) {
                ...
                if (this.slug = e,
                this.roomId = t,
                this.tempStorage = new u(e),
                o(),
                l.siteSettings.multiplayerPublicId || (l.siteSettings.set("multiplayerPublicId", s()),
                l.siteSettings.set("multiplayerPrivateId", s())),
                ...
                l.siteSettings.multiplayerGameInProgress && !l.qs.gid) {
                    var i = Math.max(0, l.siteSettings.playerRating - 3);
                    d.debug("Are on offline page, with multiplayerGameInProgress=true, decreasing playerRating by 3 points!"),
                    l.siteSettings.set("playerRating", i),
                    l.siteSettings.set("multiplayerGameInProgress", !1)
                }
                var n = this.tempStorage.get("connectlobby");
                n && n > (new Date).getTime() && !l.qs.gid && this.connect()
            }
            var t = e.prototype;
            ...
            t.createConnectionUrl = function() {
                ...
                var a = l.siteSettings.players.bottom.code
                  , i = l.siteSettings.playerName
                  , n = l.siteSettings.playerRating;
                return this.roomId && (t += "-" + this.roomId),
                e += "lobby",
                e += "?face=" + a + "&name=" + i + "&publicId=" + this.publicId + "&privateId=" + this.privateId + "&clientversion=" + siteVersion + "&game=" + t + "&type=challenge&rating=" + n
            }
            ,
            ...
            t.showChallengeDialog = function(e, t) {
                ...
                var a = l.getFaceUrl(this.opponent.face, t);
                $(e + " .player-image").css("background-image", "url(" + a + ")"),
                3 <= this.opponent.rating ? $(e + " .player-image").addClass("finisher") : $(e + " .player-image").removeClass("finisher");
                var i = l.siteSettings.favorite;
                this.opponent.id in i ? $(e + " .player-image").addClass("favorite-player") : $(e + " .player-image").removeClass("favorite-player"),
                this.showDialog(e)
            }
            ,
                ...
                if (this.opponent)
                    if (this.opponent.id === e) {
                        ...
                        if ($("#challenge-received").is(":visible"))
                            ...
                            this.checkForDeclineLimit(),
                            void delete this.opponent;
                        d.debug("Ignoring cancelled challenge from " + this.opponent.name + ", we have no dialog showing!"),
                        delete this.opponent
                    } else
                        d.debug("Ignoring cancelled challenge from id=" + e + ", we are being challenged by " + this.opponent.name);
                else
                    d.debug("Ignoring cancelled challenge from id=" + e)
            }
            ,
            t.challengeDeclined = function(e, t) {
                if (this.opponent && this.opponent.id === e) {
                    ...
                    "disconnected" === t ? r = n + " has just disconnected and can't accept your challenge. Try someone else." : "challenging" === t ? r = n + " is currently challenging someone else and can't reply to your challenge. Try someone else." : "challenged" === t && (r = n + " is currently being challenged by someone else and can't respond to your challenge. Try someone else."),
            ...
            t.createPlayerDiv = function(e) {
                var t = $("<span>").addClass("online-player").addClass("player-" + e.id).data("id", e.id).data("face", e.face)
                  ...
                  , i = e.name;
                e.id === this.publicId && i !== l.siteSettings.playerName && (i = l.siteSettings.playerName);
                var n = l.getFaceUrl(e.face, !1)
                  , r = $("<div>").addClass("face-small").addClass(a).css("background-image", "url(" + n + ")")
                  , s = $("<small>").text(i);
                t.append(r).append(s),
                3 <= e.rating && t.addClass("finisher");
                var o = l.siteSettings.favorite;
                e.id in o && t.addClass("favorite-player"),
            ...
            t.setupVisibilityHandling = function() {
                ...
                if (!this.hasSetupVisibilityHandling) {
                    ...
                    document.addEventListener("visibilitychange", function() {
                        ...
                        d.debug("Disconnecting, page is hidden"),
                        e.disconnect()),
                        "visible" === document.visibilityState && t && (e.connect(),
                        d.debug("Connecting, page is visible again!"),
                        t = !1)
                    }),
            ...
            t.onReconnect = function(e) {
                d.debug("Reconnected: " + e),
                $("#multiplayer-challenge-lobby").is(":visible") && this.socket.emit("open-lobby-window")
            }
            ,
            t.onConnectError = function(e) {
                d.error("Connection error: " + e),
    ...
    10: [function(e, t, a) {
        ...
        var n = function() {
            function e(e, t, a) {
                ...
                this.handlers = {},
                this.speechHandler = new d(function(e) {
                ...
                var n = this
                  ...
                  , e = function() {
                    ...
                    : i.shouldMakeSubstituteMove = function() {
                        if (!i.offline)
                            return !1;
                        if (((new Date).getTime() - i.offline) / l < 10)
                            return !1;
                        for (var e = r.indexOf(i), t = e + 1; t <= e + 3; t++) {
                            var a = r[t % r.length];
                            if (!a.offline)
                                return a.multiplayerId === n.publicId
                        }
                        return !1
                    }
                }
            ...
            t.beforeUnloadWindow = function() {
                if (!this.gameFinished && h.siteSettings.multiplayerGameInProgress && 1 < this.onlinePlayerCount()) {
                    o.debug("Abandoning game that still has active players, setting rating to rating - 3"),
            ...
            t.startVisibility = function(e) {
                ...
                "visible" === document.visibilityState && this.socket.connected)
                    ...
                    if (a && "hidden" === a.visibility) {
                        ...
                        h.forceTrackEvent("StartVisible", "State: " + document.visibilityState + ", Connected: " + this.socket.connected + ", lastEventWasBeforeReload: " + i + ", Agent: " + navigator.userAgent + ", Attempt: " + e, 0, h.siteSettings.playerName),
            ...
            t.connect = function() {
                ...
                n += "?face=" + t + "&name=" + i + "&publicId=" + this.publicId + "&privateId=" + this.privateId + "&clientversion=" + siteVersion + "&game=" + e + "&tableId=" + this.table.id + "&round=" + this.table.round + "&rating=" + r,
                o.debug("Connecting to " + n);
                this.socket = io(n, {
                    reconnection: !0,
                    reconnectAttempts: 10
                });
                ...
                s("connect", this.onConnect),
                s("disconnect", this.onDisconnect),
                s("player-online", this.onPlayerOnline),
                s("player-offline", this.onPlayerOffline),
                s("table-state", this.onTableState),
                s("players-ready", this.onPlayersReady),
                s("move", this.onMove),
                s("next-table", this.onNextTable),
                s("speak", this.onSpeak),
                s("table-not-found", this.onTableNotFound),
                s("get-out", this.onGetOut),
                s("sync-moves", this.onSyncMoves),
                s("migrate", this.onMigrate),
                s("rematch", this.onRematch),
                s("turn-off-timer", this.onTurnOffTimer),
                s("check-visible", this.onCheckVisible),
                s("start-game", this.onStartGame),
                s("custom-message", this.onCustomMessage),
            ...
            t.sendPhrase = function(e) {
                ...
                var a = "";
                "your-turn" === e && (a = "Sent: " + this.sentMoves.length + ", received: " + this.receivedMoves.length,
                window.game && window.game.currentPlayer && (a += " CURRENT PLAYER ID " + window.game.currentPlayer.multiplayerId)),
                this.socket.emit("speak", e, a)
            }
            ,
            ...
            t.setupBlockMuteFavoriteHandler = function() {
                var i, n = this;
                function r() {
                    $("#" + i.id + ", #block-mute .player-image").toggleClass("blocked", !!i.blocked),
                    $("#block-player").text(i.blocked ? "Unblock" : "Block"),
                    $("#" + i.id + ", #block-mute .player-image").toggleClass("muted", !!i.muted),
                    $("#mute-player").text(i.muted ? "Unmute" : "Mute"),
                    $("#" + i.id + ", #block-mute .player-image").toggleClass("favorite-player", !!i.favorite),
                    $("#favorite-player").text(i.favorite ? "Unfavorite" : "Favorite"),
                    $("#block-mute h2").text("Block/mute " + i.name)
                }
                ...
                $("#block-player").on("click", function(e) {
                    ...
                    i.blocked ? a[i.multiplayerId] = {
                        ...
                        face: i.face,
                        time: (new Date).getTime()
                    } : delete a[i.multiplayerId],
                    h.siteSettings.set("blocked", a)
                }),
                $("#mute-player").on("click", function(e) {
                    ...
                    h.siteSettings.set("muted", a)
                }),
                $("#favorite-player").on("click", function(e) {
                    i.favorite = !i.favorite,
                    r();
                    var t = i.favorite ? "Favorited" : "Unfavorited";
                    h.forceTrackEvent(t, "User " + n.players[0].name + " has " + t.toLowerCase() + "d user " + i.name);
                    var a = h.siteSettings.favorite;
                    i.favorite ? a[i.multiplayerId] = {
                        name: i.name,
                        face: i.face,
                        time: (new Date).getTime()
                    } : delete a[i.multiplayerId],
                    h.siteSettings.set("favorite", a)
                });
                var e = h.siteSettings.blocked
                  , t = h.siteSettings.muted
                  , a = h.siteSettings.favorite
                  , s = this.players
                  , o = Array.isArray(s)
                  , l = 0;
                for (s = o ? s : s[Symbol.iterator](); ; ) {
                    ...
                    $("#" + c.id).addClass("muted")),
                    a[c.multiplayerId] && (c.favorite = !0,
            ...
            t.setupTurnOffTimerHandler = function() {
                ...
                if (this.table.noTimer) {
                    ...
                    o.debug("Timer already turned off for table in previous rounds!");
                    var t = this.players
                      , a = Array.isArray(t)
                      , i = 0;
                    for (t = a ? t : t[Symbol.iterator](); ; ) {
                        ...
                        o.debug("Turned off timer for " + r.name)),
                        r._noTimer = !0
                    }
                } else
                    !1 === this.table.noTimer && ($("#ask-to-turn-off-timer").attr("disabled", "disabled"),
                    o.debug("Already asked for timer off on this table!")),
            ...
            t.onRematch = function(t, e, a) {
                ...
                if (console.log("onRematch: " + a),
                this.gameFinished) {
                    if (a && h.forceTrackEvent("RematchActiveGame", t + " - " + r + ", delayed rematch worked!"),
                    !n.is(":visible")) {
                        var s = this.players
                          , o = Array.isArray(s)
                          , l = 0;
                    ...
                    a ? h.forceTrackEvent("RematchActiveGame", t + " - " + r + ". Was retry, stopping") : (h.forceTrackEvent("RematchActiveGame", t + " - " + r + ". Trying again in 5 seconds."),
                    setTimeout(function() {
            ...
            t.onTurnOffTimer = function(t, e) {
                ...
                if (!i.is(":visible") && !this.hasShownTimerDialog) {
                    ...
                    $("#turn-off-timer-ok").attr("disabled", "disabled").show()) : $("#turn-off-timer-text").text(n.name + " is asking whether you would like to turn the timer off, so you can take as long as you want to play. Do you want to turn it off?"),
                ...
                this.players.every(function(e) {
                    ...
                    for (u = h ? u : u[Symbol.iterator](); ; ) {
                        ...
                        var f = m;
                        f.timer && f.timer.disable && f.timer.disable(),
                        f._noTimer = !0
                    }
                }
                e ? $("#turn-off-timer-faces .face-" + n.id).addClass("turn-off-timer-yes") : ($("#turn-off-timer h2").text("The timer will remain on!"),
                $("#turn-off-timer-faces .face-" + n.id).addClass("turn-off-timer-no").addClass("sad"),
            ...
            t.onPlayersReady = function(e) {
                ...
                o.debug("Players ready"),
                this.table.isPrivate || (o.debug("Players ready, setting multiplayerGameInProgress to true"),
            ...
            t.onPlayerOnline = function(t) {
                ...
                1 < this.onlinePlayerCount() && !this.gameFinished && !this.table.isPrivate && (o.debug("More than us online, setting multiplayerGameInProgress to true"),
                h.siteSettings.set("multiplayerGameInProgress", !0))
            }
            ,
            t.onPlayerOffline = function(t) {
                ...
                1 !== this.onlinePlayerCount() || this.gameFinished || (o.debug("Only us left, removing multiplayerGameInProgress"),
                h.siteSettings.set("multiplayerGameInProgress", !1))
            }
            ,
                ...
                try {
                    ...
                    try {
                        if (localStorage.dropmoves && Math.random() <= .2)
                            return void o.debug("Dropping move " + t.nr)
                    } catch (e) {}
                    var e = this.receivedMoves[this.receivedMoves.length - 1];
                    if (t.nr <= e.nr)
                        return this.dmsg += "\nDropped move nr " + t.nr + ", last nr was " + e.nr,
                        void (t.resend ? o.debug("Got resent move " + t.nr + " that I didn't need") : h.trackEvent("OldMove", "Got move " + t.nr + ", last move nr was " + e.nr));
                    if (t.nr > e.nr + 1)
                    ...
                    if (a) {
                        ...
                        i ? o.debug("Not putting our own move in the queue") : n ? o.debug("Not putting our own subsitute move in the queue") : "forcequit" === t.type ? (h.siteSettings.set("multiplayerGameInProgress", !1),
            ...
            t.sendMove = function(e) {
                ...
                try {
                    if (localStorage.dropmoves && Math.random() <= .2)
                        return void o.debug("Dropping move " + e.nr)
                } catch (e) {}
            ...
            t.sendResult = function(e, t) {
                if (void 0 === t && (t = !0),
                o.debug("Sending result: " + JSON.stringify(e)),
                ...
                e.finished) {
                    ...
                    "abandon" === e.endReason || "concede" === e.endReason && a < 18e4 || (o.debug("Increasing rating by 1, endReason was " + e.endReason + ", elapsed time was " + a + "ms"),
    ...
    11: [function(e, t, a) {
        ...
        var h = function() {
            function e(e, t) {
                ...
                this.tryLiftBan = this.tryLiftBan.bind(this),
                o(),
                this.tables = {},
                A.siteSettings.multiplayerPublicId || (A.siteSettings.set("multiplayerPublicId", s()),
                A.siteSettings.set("multiplayerPrivateId", s())),
                this.publicId = A.siteSettings.multiplayerPublicId,
                this.privateId = A.siteSettings.multiplayerPrivateId,
                this.setupEventHandlers(),
                this.setupMultiplayerButton(),
                c(function() {
                    return $(".multiplayer-lobby-link").click()
                });
                if (A.siteSettings.rcq < 3072 && (A.siteSettings.set("quitCount", 0),
                A.siteSettings.set("connectionBan", 0),
                A.siteSettings.set("rcq", 3072)),
                A.siteSettings.multiplayerGameInProgress && !A.qs.gid) {
                    var a = Math.max(0, A.siteSettings.playerRating - 3);
                    I.debug("Are on offline page, with multiplayerGameInProgress=true, decreasing playerRating by 3 points!"),
                    A.siteSettings.set("playerRating", a),
                    A.siteSettings.set("multiplayerGameInProgress", !1)
                }
                this.hasJoinedTable() && this.connect()
            }
            var t = e.prototype;
            return t.getBlockedTime = function() {
                return Math.ceil((A.siteSettings.connectionBan - (new Date).getTime()) / 1e3)
            }
            ,
            t.getBlockedTimeString = function() {
                var e = this.getBlockedTime()
                  , t = Math.floor(e / 60)
                  , a = e % 60;
                return 0 === t ? a + " seconds" : 1 === t ? t + " minute and " + a + " seconds" : t + " minutes and " + a + " seconds"
            }
            ,
            t.isBlockedFromJoining = function() {
                return A.siteSettings.playerRating < 3 && (new Date).getTime() < A.siteSettings.connectionBan
            }
            ,
            t.tryLiftBan = function() {
                if (this.isBlockedFromJoining()) {
                    if (!this.socket.connected)
                        return void $("#multiplayer-lobby").removeClass("banned");
                    this.message("You didn't finish your last game! You can't join a new game for " + this.getBlockedTimeString() + "!"),
                    $("#multiplayer-lobby").addClass("banned")
                } else
                    clearInterval(this.banInterval),
                    this.banInterval = void 0,
                    $("#multiplayer-lobby").removeClass("banned"),
                    this.message("Please select a table to join!")
            }
            ,
            t.message = function(e) {
            ...
            t.setupMultiplayerButton = function() {
                ...
                $(".multiplayer-lobby-link").on("touchstart click", function(e) {
                    ...
                    if (!A.siteSettings.playerName || "You" === A.siteSettings.playerName)
                        return $("#cover").fadeIn(),
                        $("#enter-name").show(),
                        void $("#name-new").focus();
                    $("#cover").fadeIn(),
                    $("#multiplayer-lobby").show(),
                    a.isBlockedFromJoining() && (a.banInterval = setInterval(a.tryLiftBan, 1e3));
                    var t = $("#private").position().top - ($("#lobby-message").position().top + $("#lobby-message").height()) - 10;
                    $("#multiplayer-lobby-tables").height(Math.floor(t)),
                    a.connect()
                }),
                $("#multiplayer-lobby-close").on("click", function(e) {
                    $("#cover").fadeOut(),
                    $("#multiplayer-lobby").hide(),
                    a.banInterval && ($("#multiplayer-lobby").removeClass("banned"),
                    clearInterval(a.banInterval),
                    a.banInterval = void 0),
                    a.hasJoinedTable() || a.disconnect()
                }),
            ...
            t.setupEventHandlers = function() {
                ...
                e("#create-private-table", this.createPrivateTable),
                e("#join-private-table", this.openJoinTableDialog),
                e("#join-table-ok", this.joinPrivateTable),
                $("#multiplayer-lobby").on("click", ".add-bot", function(e) {
            ...
            t.setupMessageHandlers = function() {
                ...
                e("connect_error", this.onConnectError),
                e("reconnection", this.onReconnect),
                e("private-table-created", this.onPrivateTableCreated),
                ...
                e("table-already-joined", this.onTableAlreadyJoined),
                e("table-full", this.onTableFull),
                e("table-not-found", this.onTableNotFound),
                e("player-blocked", this.onPlayerBlocked),
                e("table-remove", this.onTableRemove),
                e("start-game", this.onStartGame),
                e("start-countdown", this.onStartCountdown),
                e("update-app", this.onUpdateApp),
                e("blocked", this.onBlocked),
                $(".lobby-dialog input").on("focus", function(e) {
                    setTimeout(function() {
            ...
            t.createConnectionUrl = function() {
                var e, t = this.slug;
                e = "cardgames.io" === location.hostname || "production" === A.qs.server || APP_MODE ? "https://" + t + ".cardgames.io/" : "https://dev.cardgames.io:3031/",
                e += "lobby";
                var a = {
                    ...
                    connectionBan: A.siteSettings.connectionBan,
                    quitCount: A.siteSettings.quitCount,
                    game: t,
                    type: "jointable",
            ...
            t.onTableList = function(e) {
                ...
                a && (I.debug("We have joined one of these tables: " + a.id),
                this.tableId = a.id),
                ...
                for (i = n ? i : i[Symbol.iterator](); ; ) {
                    ...
                    o.isPrivate && $("#" + o.id).addClass("private-table"),
                    o.isPremium && $("#" + o.id).addClass("premium-table")
                }
                A.qs.join && (this.openJoinTableDialog(),
                $("#join-table-code").val(A.qs.join),
            ...
            t.onTableNotFound = function() {
                ...
                this.message("Whoops, we can't find that table on our servers. Try joining another table!"),
                $("#join-text").addClass("error").text("Table doesn't exist!"),
            ...
            t.onPlayerBlocked = function() {
                delete this.tableId,
                this.setJoinedState(!1),
                this.message("A player on this table has blocked you. Try joining another table!"),
                $("#join-table-ok").setDisabled(!1),
                $("#join-table-cancel").setDisabled(!1),
                $("#join-table-code").setDisabled(!1)
            }
            ...
            t.onStartCountdown = function(e) {
                var t = this;
                this.message("The game will start in " + e + " seconds..."),
                this.targetStart = {
            ...
            t.onTableFull = function() {
                delete this.tableId,
                this.setJoinedState(!1),
                this.message("Sorry, that table just became full, try joining another table!")
            }
            ,
            t.showMessageBox = function(e, t) {
                $("#error-message-box h3").text(e),
            ...
            t.createPrivateTable = function(e) {
                e.preventDefault(),
                this.tableId ? this.showMessageBox("Can't create table", "You have already joined a table. You must first leave that table if you want to create a new private table.") : this.socket.emit("create-private-table", this.playerCount)
            }
            ,
            t.openJoinTableDialog = function(e) {
                e && e.preventDefault(),
                $("#private-table-created").hide(),
                this.tableId ? this.showMessageBox("Can't join private table", "You have already joined a table. You must first leave that table if you want to join another private table.") : ($("#join-table-ok").setDisabled(!0),
                $("#join-table-cancel").setDisabled(!1),
                $("#join-table-code").setDisabled(!1),
                $("#join-text").text("Please enter the code for the table:").removeClass("error"),
                $("#join-private-table-dialog").show(),
                e && $("#join-table-code").focus(),
                $("#join-table-code").off("keypress").on("keypress", function(e) {
            ...
            t.joinPrivateTable = function() {
                ...
                $("#join-text").text("Attempting to join table..."),
                this.socket.emit("join-table", parseInt($("#join-table-code").val()))
            }
            ,
            t.leaveTable = function() {
                this.socket.emit("leave-table", this.tableId),
                $(".increase-margin").removeClass("increase-margin")
            }
            ,
            t.onPrivateTableCreated = function(e) {
                I.debug("Table was created: " + JSON.stringify(e)),
                this.setJoinedState(!0),
                $("#table-code").val(e.code);
                var t = "https://" + location.hostname;
                location.port && "80" != location.port && (t += ":" + location.port),
                $("#table-code-link").val(t + "/" + this.slug + "/?join=" + e.code),
                this.tableId = e.id,
            ...
            t.createPlayerDiv = function(e, t) {
                ...
                3 <= e.rating && a.addClass("finisher");
                var n = A.siteSettings.favorite;
                return e.id in n && a.addClass("favorite-player"),
                e.bot && t.players[0].id === A.siteSettings.multiplayerPublicId && a.on("click", function(e) {
            ...
            t.joinTable = function(e) {
                ...
                if (!this.tableId)
                    if (this.isBlockedFromJoining())
                        this.message("Sorry, but you too recently quit a game. Please wait for " + Math.ceil(((new Date).getTime() - A.siteSettings.connectionBan) / 1e3) + " seconds");
                    else {
                        var a, i = A.siteSettings.blocked, n = this.tables[e];
                        ...
                        a) {
                            ...
                            var r = "This table has a player, " + a.name + ", that you have blocked"
                              , s = i[a.id].name;
                            a.name !== s ? r += ' (they were called "' + s + '" when you blocked them). ' : r += ". ",
                            r += "Are you sure you want to join this table?",
                            $("#confirm-join-blocked-player p").text(r),
                            $("#confirm-join-blocked-player").show(),
                            $("#join-blocked-no").off().on("click", function() {
                                $("#confirm-join-blocked-player").hide()
                            }),
                            $("#join-blocked-yes").off().on("click", function() {
                                $("#confirm-join-blocked-player").hide(),
                                t.tableId = e,
                                t.setJoinedState(!0),
                                t.socket.emit("join-table", e)
                            })
                        } else
                            this.tableId = e,
                            this.setJoinedState(!0),
            ...
            t.setJoinedState = function(e) {
                ...
                e ? (this.playerCount.minPlayers === this.playerCount.maxPlayers ? this.message("The game will start when your table is full.") : this.message("The game will start when at least " + this.playerCount.minPlayers + " have joined."),
                $("body").addClass("joined"),
                $("#" + this.tableId).addClass("my-table"),
                this.tempStorage.set("joinedtable", !0)) : (this.message("Click a table to join a game."),
            ...
            t.onTableLeft = function() {
                delete this.tableId,
                this.message("You have left the table. Click a table to join a game."),
                this.targetStart && (clearInterval(this.targetStart.intervalId),
            ...
            t.onTableChanged = function(i) {
                ...
                if (e) {
                    ...
                    if (this.targetStart && i.players.length < this.playerCount.minPlayers && (clearInterval(this.targetStart.intervalId),
                    delete this.targetStart,
                    this.message("The game will start when at least " + this.playerCount.minPlayers + " have joined.")),
                    e.cssClass = "bottom",
                    e.name = A.siteSettings.playerName,
                    4 === this.playerCount.minPlayers) {
                        for (var n = ["left", "top", "right"], r = a + 1; r < a + 4; r++)
                            i.players[r] && (i.players[r].cssClass = n.shift());
                        n = ["left", "top", "right"];
                        for (var s = a - 1; 0 <= s; s--)
                            i.players[s] && (i.players[s].cssClass = n.pop())
                    } else if (3 === this.playerCount.minPlayers) {
                        for (var o = ["left", "top", "right"], l = a + 1; l < a + 4; l++)
                            i.players[l] && (i.players[l].cssClass = o.shift());
                        o = ["left", "top"];
                        for (var d = a - 1; 0 <= d; d--)
                            i.players[d] && (i.players[d].cssClass = o.pop())
                    } else if (2 === this.playerCount.minPlayers && 4 === this.playerCount.maxPlayers) {
                        var c = i.players;
                        if (2 === c.length)
                            c[(a + 1) % 2].cssClass = "top";
                        else if (2 < c.length)
                            for (var u = ["left", "top", "right"], h = 0; h < c.length - 1; h++)
                                c[(a + h + 1) % c.length].cssClass = u[h]
                    }
                } else if (4 === this.playerCount.minPlayers)
                    for (var p = ["bottom", "left", "top", "right"], m = i.players.length - 1; 0 <= m; m--)
                        i.players[m].cssClass = p.pop();
                else if (3 === this.playerCount.minPlayers)
                    for (var f = ["bottom", "left", "top"], g = i.players.length - 1; 0 <= g; g--)
                        i.players[g].cssClass = f.pop();
                else if (2 === this.playerCount.minPlayers && 4 === this.playerCount.maxPlayers) {
                    var y = i.players;
                    if (1 === y.length)
                        y[0].cssClass = "top";
                    else if (2 <= y.length)
                        for (var v = ["left", "top", "right", "bottom"], b = 0; b < y.length; b++)
                            y[b].cssClass = v[b]
                }
                var k = $("#" + i.id);
                0 === k.length && (k = $("<div/>", {
                ...
                i.isPrivate && (k.append($("<div/>").addClass("code").text(i.code)),
                k.addClass("private-table"),
                1 <= i.players.length && i.players[0].id === A.siteSettings.multiplayerPublicId && (k.append($("<button/>").text("Add bot").addClass("add-bot").attr("data-id", i.id)),
                $("#multiplayer-lobby-tables").addClass("increase-margin"))),
                i.isPremium && $("#" + i.id).addClass("premium-table")),
                i.id === this.tableId && k.addClass("my-table"),
                ...
                for (w = C ? w : w[Symbol.iterator](); ; ) {
                    ...
                    var E = T;
                    if (0 === $("#" + E.id).length)
                        this.createPlayerDiv(E, i).appendTo(k)
                }
            ...
            t.connect = function() {
                if (A.qs.gid)
                    return this.message("You are already playing a multiplayer game, you can't start another one right now"),
                    void $("#private").hide();
                if (!this.socket) {
                    var e = this.createConnectionUrl();
                    I.debug("Connection url: " + e),
                    this.socket = io(e, {
                        reconnection: !0,
                        reconnectAttempts: 10
                    }),
            ...
            t.onBlocked = function(e) {
                ...
                A.forceTrackEvent("BlockedLobbyClient", "Rating is: " + a.playerRating + ", name: " + a.playerName),
            ...
            ,
            t.onConnect = function() {
                I.debug("Socket connected"),
                $("#private").css("visibility", "visible"),
                r(this.socket, Object.keys(A.siteSettings.blocked))
            }
            ,
            t.onReconnect = function(e) {
            ...
            ,
            t.onConnectError = function(e) {
                $("#multiplayer-lobby-tables").html($("<div/>").attr("id", "connection-error").text("CONNECTION ERROR 😟").append($("<div/>").text("Trying to reconnect..."))),
                I.error("Connection error: " + e),
                this.setJoinedState(!1)
            }
            ,
            e
        ...
        var n = function() {
            ...
            t.start = function(a, i, n) {
                ...
                if (!this.disabled) {
                    ...
                    n = n || "Can't leave the other players waiting too long! We will play a random card for you in $REMAINING$ seconds...",
                    this.stop(),
                    this.timeoutId = s(function() {
                        if (r.disabled)
                            r.stop();
                        else {
                            ...
                            var e = Math.round(((new Date).getTime() - r.waitStart) / 1e3)
                              , t = a - e;
                            t <= 10 && (r.showMessage(n.replace("$REMAINING$", Math.max(0, t))),
                            t <= -1 && (i(),
                            r.stop()))
                        }
                    }, 1e3)
            ...
            ,
            t.stop = function() {
                this.timeoutId && (i(this.timeoutId),
        ...
        t.exports = {
            normalizeTable: function(e, t) {
                for (var a = 0; e.players[0].id !== t; ) {
                    var i = e.players.pop();
                    if (e.players.unshift(i),
                    5 < ++a)
                        throw new Error("Human player with id " + t + " not found!")
                }
                e.players[0].pos = "bottom";
                var n = e.players.length;
                2 === n ? e.players[1].pos = "top" : 3 === n ? (e.players[1].pos = "left",
                e.players[2].pos = "top") : 4 === n && (e.players[1].pos = "left",
                e.players[2].pos = "top",
            ...
            emitBlockList: function(e, t) {
                if (0 === t.length)
                    ...
                    for (var a = 0, i = 0; i < t.length; i += 300) {
                        ...
                        r.debug("Sending batch with " + n.length + " items, from " + i + " to " + (i + 300)),
                        a += n.length,
                        e.emit("blocklist", n, 0 < i)
                    }
                    r.debug("Emitted " + a + " blocked ids"),
        ...
        var s = e("../util")
          , i = function() {
            ...
            return t.speak = function(e) {
                ...
                e.preventDefault(),
                $("#phrases").fadeOut(),
                this.showBubble(e.target.id, s.siteSettings.multiplayerPublicId),
                this.send(e.target.id)
            }
            ,
            t.showBubble = function(e, t) {
                var a, i, n = $(".p-" + t).parent().find(".bubble"), r = $(".p-" + t);
                i = e.includes("emoji-") ? (a = $("#emoji-list #" + e).text(),
                "multiplayer-bubble-emoji") : (a = $("#phrases-list #" + e).text(),
                "multiplayer-bubble-text"),
                a ? "disabled" !== $("#speak").attr("disabled") ? (n.show(),
                a.includes(":(") && r.addClass("sad"),
                n.find("p span").html($("<span/>").addClass(i).text(a)),
                n.find("div").hide(),
                n.find("img").hide(),
                setTimeout(function() {
                    n.fadeOut(),
    ...
    17: [function(e, t, a) {
        "use strict";
        var i, n = e("./util"), r = n.logError, s = n.qs, o = (n.cake,
        e("../shared/helper-functions").captainsLog), c = e("./page").slug, u = !!s.gid;
        try {
        ...
        var y = {
            ...
            startGame: function(r, s) {
                ...
                f(function(e) {
                    ...
                    for (var t = 0; t < r.length; t++) {
                        ...
                        e.players[i] || (e.players[i] = g(s));
                        var n = e.players[i];
                        n.gameCount++,
                        n.abandonedGameCount++
                    }
                }))
            },
            cancelGame: function() {
                if (this.enabled && this.currentPlayers) {
                    ...
                    var r = this.options;
                    f(function(e) {
                        e.playersInGameCount[n.length] = (e.playersInGameCount[n.length] || 0) - 1,
                        e.gameCount--,
                        e.abandonedGameCount--;
                        for (var t = 0; t < n.length; t++) {
                            var a = n[t];
                            if ("multi-player" !== a.id) {
                                e.players[a.id] || (e.players[a.id] = g(r));
                ...
                if (this.enabled) {
                    ...
                    if (f(function(e) {
                        ...
                        for (var t = 0; t < o.length; t++) {
                            ...
                            var n = e.players[i];
                            for (var r in n || (e.players[i] = g(c),
                            (n = e.players[i]).abandonedGameCount++,
                            n.gameCount++),
                            a.stats = a.stats || {},
                            a.stats.score |= 0,
                            n.abandonedGameCount = Math.max(n.abandonedGameCount - 1, 0),
                            n.finishedGameCount++,
                            n.totalScore += a.stats.score,
                            n.minScore = null === n.minScore ? a.stats.score : Math.min(n.minScore, a.stats.score),
                            n.maxScore = null === n.maxScore ? a.stats.score : Math.max(n.maxScore, a.stats.score),
                            n.avgScore = n.totalScore / n.finishedGameCount,
                            n.totalGameTime += l,
                            "win" == a.stats.result ? (n.winCount++,
                            n.winningStreak++,
                            n.losingStreak = 0,
                            n.maxWinningStreak = Math.max(n.maxWinningStreak, n.winningStreak),
                            null === n.minWonGameTime ? n.minWonGameTime = l : l < n.minWonGameTime && (d.push({
                                oldTime: n.minWonGameTime,
                                newTime: l,
                                name: a.name
                            }),
                            n.minWonGameTime = l),
                            n.minWonGameTime = null === n.minWonGameTime ? l : Math.min(n.minWonGameTime, l),
                            n.maxWonGameTime = null === n.maxWonGameTime ? l : Math.max(n.maxWonGameTime, l),
                            n.totalWonGameTime += l,
                            n.avgWonGameTime = n.totalWonGameTime / n.winCount) : "lose" == a.stats.result ? (n.loseCount++,
                            n.winningStreak = 0,
                            n.losingStreak++,
                            n.maxLosingStreak = Math.max(n.maxLosingStreak, n.losingStreak)) : "draw" == a.stats.result && (n.drawCount++,
                            n.winningStreak = 0,
                            n.losingStreak = 0),
                            n.winPercentage = n.winCount / n.finishedGameCount,
                            a.stats.tournamentResult && (n.finishedTournamentCount++,
                            n.totalTournamentScore += a.stats.tournamentScore,
                            n.avgTournamentScore = n.totalTournamentScore / n.finishedTournamentCount,
                            "win" == a.stats.tournamentResult ? (n.winTournamentCount++,
                            n.tournamentWinningStreak++,
                            n.tournamentLosingStreak = 0,
                            n.tournamentMaxWinningStreak = Math.max(n.tournamentMaxWinningStreak, n.tournamentWinningStreak)) : "lose" == a.stats.tournamentResult && (n.loseTournamentCount++,
                            n.tournamentLosingStreak++,
                            n.tournamentWinningStreak = 0,
                            n.tournamentMaxLosingStreak = Math.max(n.tournamentMaxLosingStreak, n.tournamentLosingStreak)),
                            n.tournamentWinPercentage = n.winTournamentCount / n.finishedTournamentCount),
                            a.stats)
                                if (!r.match(/^(score|result|tournamentResult|tournamentScore)$/)) {
                                    var s = a.stats[r];
                                    "number" == typeof s && (r.match(/maximum/) ? (void 0 === n[r] || s > n[r]) && (n[r] = s) : r.match(/minimum/) ? (void 0 === n[r] || s < n[r]) && (n[r] = s) : (n[r] |= 0,
                                    n[r] += a.stats[r]))
                                }
                        }
                    }),
            ...
            finishMultiplayerChallengeGame: function(s, o, l, d) {
                void 0 === o && (o = !1),
                void 0 === l && (l = !1),
                void 0 === d && (d = !0),
                f(function(e) {
                    ...
                    if (a) {
                        if ("win"in a && !("games"in a)) {
                            ...
                            var n = e.multiplayer.findIndex(function(e) {
                                return e.name === t.name && e.face === t.face
                            });
                            e.multiplayer[n] = a
                        }
                    ...
                    function r(e, t, a, i) {
                        "win" === t.stats[i] ? e[a].won++ : "lose" === t.stats[i] ? e[a].lost++ : e[a].draw++
                    }
                    o ? (l && r(a, t, "games", "tournamentResult"),
                    d && r(a, t, "hands", "result")) : r(a, t, "games", "result"),
    ...
    19: [function(e, t, a) {
        ...
        "dev.cardgames.io" == document.location.hostname && (p.level = "debug"),
        ...
        function f(e, t, a, i) {
            ...
            if (null === f(h) && e !== h && !APP_MODE)
                return g(e, t),
                void console.log("Consent has not been given to set cookies, using dough for " + e + "=" + t + " ...");
            navigator.cookieEnabled || (p.debug("Cookies are disabled in this browser, setting up temporary value " + e + "=" + t + " ..."),
            g(e, t));
            ...
            try {
                ...
                if (c != t) {
                    ...
                    v("CAKEFAIL", "Name=" + e + ", set " + t + ", got " + c + ", cookies=" + navigator.cookieEnabled + ", firefox=" + u + ", cookie=" + document.cookie, 0, "", "", 1)
                }
            } catch (e) {}
        }
        function g(e, t) {
        ...
        function y(e) {
            ...
            try {
                ...
                a && "object" == typeof a && void 0 !== a[e] && (delete a[e],
                window.name = JSON.stringify(a))
            } catch (e) {}
        }
        try {
        ...
        function v(e, t, a, i, n, r) {
            ...
            i = i || "",
            n = n || "",
            "Error" === (e = e || "") && "" === i && "undefined" != typeof window && (i = window.siteVersion || ""),
            APP_MODE) {
                var s = navigator.userAgent || "";
                n = s.match(/iPhone/i) ? "APP-iPhone" : s.match(/iPad/i) ? "APP-iPad" : s.match(/android/i) ? "APP-Android" : "APP-Unknown - " + s
            }
            r = r || v.PROBABILITY,
            p.debug("TrackEvent: action=" + e + ", label=" + t + ", value=" + a + ", variable1=" + i + ", variable2=" + n + ", probability=" + r),
            APP_MODE && (r = 1),
            Math.random() <= r && m.events.post({
                category: category,
                action: e,
                label: t,
                value: a,
        ...
        v.PROBABILITY = .01;
        var u, b, k = {}, w = document, C = "loc", S = "hos", T = Math, E = {};
        function A(r, s, e) {
            void 0 === e && (e = !0),
            this.meta = {
                prefix: r,
            ...
            function t(e) {
                for (var t in e)
                    if (t.substr(0, r.length) == r) {
                        ...
                        if (void 0 === n)
                            continue;
                        if (void 0 !== n.defaultValue && (n = n.defaultValue),
                        "number" == typeof n)
                            o[i] = parseFloat(a);
                            ...
                            o[i] = "object" == typeof n ? JSON.parse(a) : a
                    }
            }
            try {
                window.localStorage && t(localStorage)
            } catch (e) {}
            for (var a in t(this.meta.cookies),
            s)
                this.meta.listeners[a] = [],
                void 0 === this[a] && (s[a] && void 0 !== s[a].defaultValue ? this[a] = s[a].defaultValue : this[a] = JSON.parse(JSON.stringify(s[a])))
        }
        $(window).on("beforeunload", function() {
            for (var e in E) {
                var t = E[e];
                for (var a in t)
                    if (void 0 !== t[a] && "function" != typeof t[a]) {
                        var i = e + a
                          , n = t[a];
                        "object" != typeof n && ("boolean" != typeof n && "number" != typeof n || (n = n.toString()),
                        localStorage.getItem(i) && n != localStorage.getItem(i) && t.set(a, t[a]))
                    }
            }
        }),
        ...
        A.prototype.set = function(n, r) {
            if (APP_MODE || null !== f(h)) {
                if (void 0 === this[n] || "function" == typeof this[n])
                    throw "Invalid key: " + n;
                if (typeof r != typeof this[n])
                    throw "Unexpected type for " + n + ", expected " + typeof this[n] + ", got " + typeof r;
                var e, t;
                if (this[n] = r,
                void 0 !== this.meta.defaults[n].defaultValue) {
                ...
                if (r == e) {
                    ...
                    if (t) {
                        ...
                        if (!o)
                            throw "Bad value for " + n + ": " + r + ". Allowed values are: " + t
                    }
                    d();
                    try {
                ...
                console.log("GDPR consent has not been given, ignoring " + n + "=" + r);
            function d() {
                var e = s.listeners[n]
                  , t = Array.isArray(e)
                  , a = 0;
        ...
        ;
        try {
            u = new A(slug,defaultSettings)
        } catch (e) {
            alert("ERROR when loading settings for " + slug + ", err: " + e)
        }
        try {
            b = new A("site",window.defaultSiteSettings || {})
        } catch (e) {
        ...
        window.players) {
            for (var I in players) {
                ...
                var P = players[I].code + ""
                  , x = P.match(/^\d+$/) ? P : P.charAt(2);
                $(".face-" + I + "-player.face-small").addClass("hair-" + x),
                $("#challenge-yourself .face-bottom-player").addClass("hair-" + x)
            }
            $("#temphidenames").remove()
        }
        ...
        if (!function() {
            ...
            if (e)
                for (var t = e.split("&"), a = 0; a < t.length; a++) {
                    var i = t[a].split("=")
                      , n = i[0]
                      , r = i[1];
                    n = s(window.settings || {}, n),
                    n = s(b, n),
                    r = l(r),
                    _[n] = r,
                    o(window.settings || {}, n, r),
                    o(b, n, r)
                }
            function s(e, t) {
                for (var a in e)
                ...
                if (void 0 !== i)
                    if ("boolean" != typeof i || "number" != typeof a) {
                        if (typeof i != typeof a)
                            throw "Incompatible types for " + t + ": " + typeof i + " and " + typeof a;
                        e[t] = a
                    } else
                        e[t] = !!a
            }
            function l(e) {
                ...
                if ("false" == e)
                    return !1;
                if (e.match(/,/)) {
                    for (var t = (e = e.replace(/,$/, "")).split(","), a = 0; a < t.length; a++)
                        t[a] = l(t[a]);
                    return t
                }
                return e
        ...
        try {
            ...
            C += "ation",
            S += "tname",
            R = document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1")
        } catch (e) {}
        function D(e, t) {
        ...
        o(function e() {
            if (l.isGameStarted()) {
                ...
                var t = f("cid") || function() {
                    for (var e = "", t = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", a = 0; a < 10; a++)
                        e += t.charAt(Math.floor(Math.random() * t.length));
                    return e
                }();
                f("cid", t, 365, "/");
                var a = "undefined" == typeof google && 0 === document.getElementsByTagName("iframe").length
        ...
        APP_MODE && o(function() {
            ...
            f("appversion") === t ? p.debug("Not logging version, already done it today") : (v("AppOpen", window.siteVersion + "" || "Unknown"),
            f("appversion", t, 1, "/"))
        }, 1e4);
        var N = document.location.hash.match(/#logerrors=(\w+)/);
        if (N)
            !function() {
                try {
            ...
            f("logerrors", N[1], 1, "/");
        else if (!APP_MODE && ("." != D(O, 3) || "o" != D(O, 1)) && "9" != D(O, 12)) {
        ...
        function B(e, t, a, i, n, r, s) {
            ...
            "RummyError" !== r)
                try {
                    ...
                    10 <= d.length && d.shift(),
                    v("Error", o + "|| UserAgent: " + navigator.userAgent.replace(/Mozilla\/5\.0/, ""), a || 0);
                    var c = l + " " + new Date + ":\r\n\r\n " + (n && n.stack ? n.stack : e)
                      , u = c.split(/\r?\n/);
                    ...
                    for (var h = 0; h < u.length; h++)
                        u[h] = u[h].replace(/https?:\/\/(dev\.)?cardgames\.io(:\d+)?\/\w+/, "");
                    if (c = u.join("\r\n"),
                    d.push(c),
        ...
        window.logError = B,
        window.onerror || (window.onerror = B);
        var F = {
            open: function() {
                V(),
                ...
                s(function() {
                    return $("#wrapper").on("click", G)
                }, 100),
                $("#mobile-menu").css("z-index", 9999999999)
            },
            close: function() {
                F.isOpen() && ($("body").removeClass("menu-open"),
        ...
        function H() {
            window.scrollY ? f("scroll", scrollY) : void 0 === window.scrollY && window.pageYOffset && f("scroll", window.pageYOffset),
            f("reload", "1"),
        ...
        function j(e) {
            ...
            if (t.prop("checked")) {
                ...
                $("#customizable-links").prepend(i),
                30 < $("#promo-mini").height() && (i.remove(),
                t.prop("checked", !1),
        ...
        $(function() {
            ...
            APP_MODE)
                ...
                if (null !== e) {
                    ...
                    if (t && t + 31536e6 > (new Date).getTime()) {
                        ...
                        var a = f(h).split("_")[2];
                        return -1 !== NON_GDPR_COUNTRES.indexOf(a) && $("html").addClass("non-gdpr-country"),
                        void (null === f("app_prompt") || APP_MODE ? function() {
                            ...
                            try {
                                ...
                                if (null === f("app_prompt") && n) {
                                    var s = parseInt(n[1]);
                                    f("app_prompt", (new Date).getTime(), 4, "/"),
                                    i ? 12 <= s ? ($("#get-app, #app-icon").attr("href", r),
                                    v("iPadAppPrompt", s.toString(), 0, "", "", 1),
                                    $("#app-prompt").slideDown()) : v("iPadOldVersion", s.toString(), 0, "", "", 1) : a ? 12 <= s ? ($("#get-app, #app-icon").attr("href", r),
                                    v("iPhoneAppPrompt", s.toString(), 0, "", "", 1),
                                    $("#app-prompt").slideDown()) : v("iPhoneOldVersion", s.toString(), 0, "", "", 1) : t && (5 <= s ? ($("#get-app, #app-icon").attr("href", "market://details?id=io.cardgames.app"),
                                    v("AndroidAppPrompt", s.toString(), 0, "", "", 1),
                                    $("#app-prompt").slideDown()) : v("AndroidOldVersion", s.toString(), 0, "", "", 1))
                                }
                            } catch (e) {
                            ...
                            try {
                                ...
                                if (null === f("fruit_prompt") && n) {
                                    var s = parseInt(n[1]);
                                    f("fruit_prompt", (new Date).getTime(), 30, "/"),
                                    i || a ? 10 <= s && ($("#get-fruit-monster-island").attr("href", "itms-apps://itunes.apple.com/app/apple-store/id1564432703?pt=118730957&ct=cardgames.io&mt=8"),
                ...
                $.getJSON("/lambda/country").done(function(e) {
                    ...
                    -1 !== NON_GDPR_COUNTRES.indexOf(e.country) || !0 === navigator.standalone ? (f(h, (new Date).getTime() + "_true_" + e.country, 365, "/"),
                    o(function() {
                        return W.initialize()
                    }, 2e3),
            ...
            function i(i) {
                ...
                $("#gdpr-agree").on("click", function(e) {
                    ...
                    $("html").addClass("gdpr-accepted"),
                    c("GdprAccept", "", t ? 1 : 0),
                    m.gdpr.accept(t, navigator.userAgent, function(e) {
        ...
        !0 === navigator.standalone && $(document).on("click", "a", function(e) {
            ...
            if (t && !t.match(/#/) && !t.match(/javascript:/)) {
                ...
                t.substr(0, a.length) === a && (e.preventDefault(),
                location.href = t)
            }
        }),
        ...
        var W = {
                ...
                if (!APP_MODE) {
                    ...
                    if ("none" !== this.type)
                        if (d() || b.alwaysUseInterstitialAds) {
                            ...
                            r && !_.realads && s.setAttribute("data-adbreak-test", "on"),
                            s.onload = function() {
                                p.debug("ADS: loaded script"),
                                adConfig({
                                    preloadAdBreaks: "on",
                                    sound: "off",
                                    onReady: function() {
            ...
            trigger: function(e) {
                ...
                if (APP_MODE) {
                    ...
                    if ("none" === this.type)
                        return p.debug("ADS: No ad triggered. Type=" + this.type),
                        void e();
                    if (!this.adsAreReady)
                        return p.debug("ADS: Ads API has not finished loading yet"),
                        void e();
                    var a = (new Date).getTime() - this.lastAdShown;
                    if (a < 24e4 && "immediate" !== _.ads)
                        return p.debug("ADS: Only " + a / 1e3 + " seconds since last ad was shown, not showing ad yet!"),
                        void e();
                    p.debug("ADS: Calling adBreak"),
            ...
            beforeAd: function() {
                p.debug("ADS: beforeAd called"),
                this.bf = "Before " + (new Date).toString()
            },
            afterAd: function() {
                p.debug("ADS: afterAd called"),
                this.af = "After " + (new Date).toString()
            },
            adBreakDone: function(e) {
                this.abf = "AdBreakDone: " + (new Date).toString(),
                p.debug("ADS: AdBreakDone: " + JSON.stringify(e, null, 2)),
                clearTimeout(this.testId),
                delete this.testId;
                var t = (new Date).getTime()
                  , a = this.lastAdShown;
                "viewed" === e.breakStatus && (this.lastAdShown = t,
                0 < a && c("AdIntervalManual", Math.round((t - a) / 1e3).toString()));
        ...
        t.exports = {
            ...
            getFaceUrl: function(e, t) {
                if (e.toString().match(/^\d\d?$/))
                    return t ? "face-" + e + "-sad.svg" : "face-" + e + ".svg";
            ...
            showConfetti: function() {
                b.confetti && Y("/shared/effects/" + siteVersion + "/confetti.min.js", function() {
                    var e = $("<div>", {
        ...
        var i = e("../shared/helper-functions")
          ...
          , n = function() {
            ...
            t.notifyPlay = function(e, t, a) {
                if (0 < e.length && e[0].suit !== a.suit && (this.playerInfo[t.name][e[0].suit] = !1),
                _.remove(this.remaining[a.suit], a.rank),
                0 === this.remaining[a.suit].length)
                    for (var i in this.playerInfo)
                        this.playerInfo[i][a.suit] = !1
            }
            ,
            t.removeLowerAdjacentCards = function(e) {
                ...
                return e.toString() != t.toString() && R.debug("Was " + e + ", now is " + t),
                t
            }
            ,
            t.play = function(e) {
                ...
                this.sortPlayable(e),
                0 === this.game.pile.length && R.debug("-------------"),
                R.debug(this.name + ": " + e),
                0 === this.game.pile.length ? this.playPos1(e) : 1 === this.game.pile.length ? this.playPos2(e) : 2 === this.game.pile.length ? this.playPos3(e) : 3 === this.game.pile.length && this.playPos4(e)
            }
            ,
            ...
            t.opponentHasGoodNilBid = function() {
                for (var e = 0; e < this.game.players.length; e++) {
                    ...
                    if (t !== this && t !== this.partner && 0 === t.bidValue && 0 === t.tricks.length)
                        return t
                }
                return null
            }
            ...
            t.playPos1 = function(e) {
                var u = this
                  ...
                  , a = function() {
                    ...
                    var r = u.playerInfo[h.name]
                      ...
                      , l = !1 === r.s && !1 === s.s;
                    if (!g && l && o ? t.goodness += 1e3 : f || !o || l || (t.goodness -= 10),
                    t.isSpade && (t.goodness -= 1),
                    13 === t.rank) {
                        var d = !!u.hand.find(function(e) {
                            return e.suit === t.suit && 14 === e.rank
                        })
                          , c = u.remaining[t.suit].includes(14);
                        g || d || !c || 0 === u.bidValue || u.opponentHasGoodNilBid() || (t.goodness = -10,
                        R.debug("Not leading the king because reasons"))
                    }
                }
                  , y = e
                  , v = Array.isArray(y)
                ...
                g ? (R.debug("Playing best card to try to help partner make nil bid"),
                this.playCard(i)) : r ? (this.playCard(n),
                R.debug(this.name + " leading worst card to try to ruin " + r.name + "'s nil bid")) : this.haveMadeBid() ? this.shouldGetBags() ? (R.debug(this.name + " has made bid, trying for bags in lead to set others."),
                this.playCard(i)) : (R.debug(this.name + " has made bid, trying to lose lead"),
                this.playCard(n)) : 0 === this.bidValue ? (R.debug(this.name + " has nil bid, trying to lose in lead"),
                this.playCard(n)) : this.playCard(i)
            }
            ,
            t.playPos2 = function(e) {
                ...
                i && !a && t.bestThatCanWin ? t.worstThatCanWin && t.worstThatCanWin.isSpade && !this.game.pile[0].isSpade ? (R.debug(this.name + " playing worst card that can win, since it is a trump and our nil bidding partner will not take it"),
                this.playCard(t.worstThatCanWin)) : (R.debug(this.name + " playing best card to win, to help nil bid buddy"),
                this.playCard(t.bestThatCanWin)) : n && this.game.pile[0].playedBy === n && t.bestThatCanLose ? (R.debug(this.name + " trying to ruin nil bid from " + n.name),
                this.playCard(t.bestThatCanLose)) : this.haveMadeBid() ? this.shouldGetBags() ? (R.debug(this.name + " has made bid, trying for bags to set others. pos 2"),
                this.winPos2(t)) : (R.debug(this.name + " has made bid, trying to lose pos 2"),
                this.losePos2(t)) : 0 === this.bidValue ? (R.debug(this.name + " has nil bid, trying to lose pos 2"),
                this.losePos2(t)) : this.winPos2(t)
            }
            ,
            t.winPos2 = function(e) {
                if (e.worstThatCanWin)
                    if (e.worstThatCanWin.isSpade && !this.game.pile[0].isSpade)
                        this.playCard(e.worstThatCanWin);
                    else {
                    ...
                    this.playCard(e.worstThatCanLose)
            }
            ,
            ...
            t.getImportantCards = function(e) {
                ...
                this.canWinCard(e[0], a) || (t.worstThatCanLose = e[0]),
                this.canWinCard(e[e.length - 1], a) && (t.bestThatCanWin = e[e.length - 1]);
                var i = e
                  , n = Array.isArray(i)
                  , r = 0;
                for (i = n ? i : i[Symbol.iterator](); ; ) {
            ...
            t.playPos3 = function(e) {
                var t = this.getImportantCards(e)
                  ...
                  , r = this.opponentHasGoodNilBid();
                i && n ? this.winPos3(t, a, i) : this.haveMadeBid() ? this.shouldGetBags() ? (R.debug(this.name + " has made bid, trying for bags to set others. pos 4"),
                this.winPos3(t, a, i)) : (R.debug(this.name + " has made bid, trying to lose pos 3"),
                this.losePos3(t, a, i)) : 0 === this.bidValue ? (R.debug(this.name + " has nil bid, trying to lose pos 3"),
                this.losePos3(t, a, i)) : r && t.worstThatCanLose ? (R.debug(this.name + " trying to ruin nil bid from " + r.name),
                this.playCard(t.worstThatCanLose)) : this.winPos3(t, a, i)
            }
            ,
            ...
            t.winPos3 = function(t, e, a) {
                ...
                if (a) {
                    ...
                    if (n)
                        t.worstThatCanWin ? this.playCard(t.worstThatCanWin) : this.playCard(t.worstThatCanLose);
                    else {
                        if (!t.worstThatCanWin)
                            return void this.playCard(t.worstThatCanLose);
                        var r = this.nextPlayer()
                          , s = this.game.pile[0].suit
                          , o = !1 === this.playerInfo[r.name][s]
                          , l = !1 === this.playerInfo[r.name].s;
                        if (o && l)
                            return void this.playCard(t.worstThatCanLose || t.worstThatCanWin);
                        if (this.remaining[s].some(function(e) {
                            return e > i.game.pile[0].rank
                        }) && !o) {
                            if (t.worstThatCanWin.isSpade && s !== D)
                                this.playCard(t.worstThatCanWin);
                            else {
                    ...
                    t.worstThatCanWin && t.worstThatCanWin.isSpade ? this.playCard(t.worstThatCanWin) : t.bestThatCanWin ? this.playCard(t.bestThatCanWin) : this.playCard(t.worstThatCanLose)
            }
            ,
            ...
            t.playPos4 = function(e) {
                ...
                s && s === a.playedBy && t.worstThatCanLose ? (R.debug(this.name + " trying to ruin nil bid from " + a.playedBy),
                this.playCard(t.worstThatCanLose)) : i && n && !r ? (R.debug(this.name + " trying to help partner keep good nil bid"),
                this.winPos4(t, a, i)) : this.haveMadeBid() ? this.shouldGetBags() ? (R.debug(this.name + " has made bid, trying for bags to set others. pos 4"),
                this.winPos4(t, a, i)) : (R.debug(this.name + " has made bid, trying to lose pos 4"),
                this.losePos4(t, a, i)) : 0 === this.bidValue ? (R.debug(this.name + " has nil bid, trying to lose pos 4"),
                this.losePos4(t, a, i)) : this.winPos4(t, a, i)
            }
            ,
            t.winPos4 = function(e, t, a) {
                if (a) {
                    ...
                    e.worstThatCanWin ? this.playCard(e.worstThatCanWin) : this.playCard(e.worstThatCanLose)
            }
            ,
            ...
            t.bid = function() {
                ...
                if (13 !== this.partner.bidValue) {
                    ...
                    for (a = i ? a : a[Symbol.iterator](); ; ) {
                        ...
                        var s = r;
                        t[s.suit].count++,
                        14 === s.rank && (t[s.suit].hasAce = !0),
                        13 === s.rank && (t[s.suit].hasKing = !0),
                        12 === s.rank && (t[s.suit].hasQueen = !0)
                    }
                    ...
                    R.debug("********** " + this.name + " BID ***************"),
                    R.debug(this.name + ": Hard Bid is " + l);
                    ...
                    for (var w in R.debug(this.name + ": Low spade bid is " + k),
                    d += k,
                    t)
                        if (w !== D) {
                            var C = t[w];
                            C.hasAce && C.hasKing ? (d += 2,
                            R.debug(this.name + " Bid for King+Ace in " + w + ": 2")) : C.hasAce ? (d += 1,
                            R.debug(this.name + " Bid for Ace in " + w + ": 1")) : C.hasKing && 2 <= o.length && (d += .5,
                            R.debug(this.name + " Bid for King in " + w + ": 0.5"))
                        }
                    var S = Math.min(1, d);
                    R.debug(this.name + " lowering soft bid by " + S);
                    var T = l + (d -= S);
                    if (R.debug(this.name + " Soft+Hard Bid: " + T),
                    this.shouldBidNil(T, m, t))
                        this.game.bid(this, 0);
                    else {
                        T = Math.ceil(T),
                        T = Math.min(T, 7),
                        T = Math.max(T, 1);
                        if (7 <= this.partner.bidValue)
                            R.debug(this.name + " changing bid from " + T + " to hard bid " + l + " because our partner has 6 or more"),
                            T = l;
                        else if (11 < T + this.partner.bidValue) {
                            var $ = T;
                            T = Math.max(11 - this.partner.bidValue, l),
                            R.debug(this.name + " changed bid from " + $ + " to " + T + " because the combined bid was higher than 11")
                        }
                        var E = this.bags
                        ...
                        if (0 < this.partner.bidValue) {
                            ...
                            T = this.reduceBidForEndGame(I, T, T, E);
                        if (T < P && R.debug(this.name + " reduced bid from " + P + " to " + T + " because of endgame strategy"),
                        T < l && (R.debug(this.name + " changing bid again from " + T + " to hardBid: " + l),
                        T = l),
                        0 < this.partner.bidValue && 13 < this.partner.bidValue + T) {
                            var x = this.name + " has to lower bid because partner bid is too high";
                            R.debug(x),
                            T = 13 - this.partner.bidValue
                        }
                        T = Math.max(T, 1),
                        this.game.bid(this, T)
                    }
                } else
                    this.game.bid(this, 0)
            }
            ...
            t.shouldBidNil = function(e, t, a) {
                if (3 < e || 0 === this.partner.bidValue || 0 < t)
                    return !1;
                for (var i in a)
                    if (a[i].hasAce || a[i].hasKing)
                        return !1;
            ...
            t.reduceBidForEndGame = function(e, t, a, i) {
                ...
                if (e < n) {
                    ...
                    if (10 <= i + s)
                        return t;
                    if (5 <= s)
                        return R.debug(this.name + ": Extra tricks is " + s + ", reducing bid by 2 to make it to " + this.game.winScore),
                        t - 2;
                    if (1 <= s)
                        return R.debug(this.name + ": Extra tricks is " + s + ", reducing bid by 1 to make it to " + this.game.winScore),
                        t - 1
                }
                return t
            }
    ...
    21: [function(e, t, a) {
        ...
        var i = e("../shared/cardgames/cardgame")
          , n = function(s) {
            function e() {
                var e;
                return (e = s.call(this) || this).cardCount = 13,
                e.sortType = "suit",
                e.canSelectCards = !1,
                ...
                e.winScore = 500,
                e.nilBidBonus = 100,
                e.pointsPerBidTrick = 10,
                e.pointsPerBag = 1,
                e.tenBagsPenalty = 100,
                e.previousGameScores = null,
                e.renderers.spadesbroken = e.makeRenderFunc("spadesbroken - @player.name breaks spades"),
                e.renderers.taketrick = e.makeRenderFunc("taketrick - @player.name takes the trick"),
                e.renderers.bid = e.makeRenderFunc("bid - @player.name bids @bid"),
                e.renderers.startbid = e.makeRenderFunc("startbid - @player.name"),
                e
            }
            !function(e, t) {
            ...
            t.canPlayCard = function(e, t) {
                if (0 === this.pile.length)
                    return !t.isSpade || (this.spadesIsBroken || e.hand.every(function(e) {
                        return e.isSpade
                    }));
            ...
            t.afterDealing = function() {
                ...
                for (e = t ? e : e[Symbol.iterator](); ; ) {
                    ...
                    var n = i;
                    if ("bottom-player" === n.id && !this.handSorted)
                        return this.handSorted = !0,
                        this.sortHand(n, this.afterDealing);
                    n.tricks = [],
                    n.bidValue = -1
                }
                for (var r = 0; r < this.players.length; r++)
                    this.players[r].partner = this.players[(r + 2) % this.players.length];
                var s = this.players
                  , o = Array.isArray(s)
                  , l = 0;
                for (s = o ? s : s[Symbol.iterator](); ; ) {
            ...
            ,
            t.bid = function(e, t) {
                var a = 13 - (-1 !== e.partner.bidValue ? e.partner.bidValue : 0);
                (t < 0 || a < t) && (t = Math.max(Math.min(move.bid, a), 0)),
                e.bidValue = t,
            ...
            ,
            t.playCards = function(e, t) {
                t[0].isSpade && !this.spadesIsBroken && (this.spadesIsBroken = !0,
            ...
            t.calculateScore = function() {
                function e(e, t) {
                    ...
                    for (var i = 0, n = [e, t]; i < n.length; i++) {
                        var r = n[i];
                        0 === r.bidValue && 0 === r.tricks.length ? a.nilBidScore += 100 : 0 === r.bidValue && 0 < r.tricks.length ? (a.nilBidPenalty -= 100,
                        a.bags += r.tricks.length) : a.tricks += r.tricks.length
                    }
                    return a.bags += Math.max(0, a.tricks - a.bid),
                    a.tricks >= a.bid ? a.tricksScore += 10 * a.bid : a.tricksPenalty -= 10 * a.bid,
                    a.totalBags = a.bags + a.bagsPrevRound,
                    a.bagsNextRound = a.totalBags,
                    a.bagsScore = a.bags,
                    10 <= a.bagsNextRound && (a.bagsPenalty -= 100,
                    a.bagsNextRound -= 10),
                    a.score = a.tricksScore + a.tricksPenalty + a.bagsScore + a.bagsPenalty + a.nilBidScore + a.nilBidPenalty,
                    a.scoreTotal = a.score + a.scoreLastRound,
                    a
                }
                ...
                if (t.scoreTotal < this.winScore && a.scoreTotal < this.winScore || t.scoreTotal >= this.winScore && t.scoreTotal == a.scoreTotal)
                    this.renderEvent("win", function() {}, {
                        team1: t,
                        team2: a,
                ...
                else if (t.scoreTotal >= this.winScore && t.scoreTotal > a.scoreTotal)
                    this.renderEvent("win", function() {}, {
                        team1: t,
                        team2: a,
                        winner: i,
            ...
            t.afterPlayCards = function() {
                if (this.pile.length < this.players.length)
                    ...
                    for (var e = 0, t = this.pile[0], a = (this.currentPlayerIndex + 1) % this.players.length, i = 1; i < this.pile.length; i++) {
                        var n = this.pile[i];
                        !t.isSpade && n.isSpade ? (t = n,
                        e = i) : n.suit == t.suit && n.rank > t.rank && (t = n,
                        e = i)
                    }
        ...
        var i = e("../shared/multiplayer/multiplayer-util").AutoPlayTimer
          ...
          , s = function() {
            ...
            t.bid = function(e) {
                ...
                try {
                    localStorage.autohuman && ($("#bid-div").hide(),
                    this.doBid(3))
                } catch (e) {
            ...
            ,
            t.hoverCard = function(e){
                $(e.guiCard).addClass('glow');
            }
            ,
            t.dehoverCard = function(e) {
                $(e.guiCard).removeClass("glow");
            }
            ,
            t.useCard = function(e) {
                if (e.random ? this.randomMovesCount++ : this.randomMovesCount = 0,
                this.isBidding)
                    return this.game.message("It's your turn to bid now. You can't play any card while you're bidding!");
                this.game.message(""),
                this.hand.includes(e) ? this.canPlay ? this.playable.includes(e) ? (this.timer.stop(),
                this.game.playCards(this, [e])) : this.cannotPlayCardMessage(e) : this.game.message("It's not your turn to play!") : this.game.useIllegalCard(this, e)
            }
            ,
            t.play = function(t) {
                var a = this;
            ...
            t.cannotPlayCardMessage = function(e) {
                ...
                if (!e.isSpade || this.game.spadesIsBroken)
    ...
    23: [function(e, t, a) {
        ...
        var r = e("../shared/helper-functions").captainsLog
          ...
          , n = function(n) {
            function e(e) {
                var t;
                return (t = n.call(this, e) || this).multiplayerMoves = [],
                t
            }
            !function(e, t) {
                e.prototype = Object.create(t.prototype),
                ...
                if (this.shouldMakeSubstituteMove())
                    ...
                    if (a)
                        ...
                        "play" === a.type) {
                            ...
                            i ? (i.random = a.random,
                            this.game.playCards(this, [i])) : r.error("Player " + this.id + " did not find card " + a.cards + ", hand was: " + this.hand)
                        } else
                            r.error(this.id + " got unexpected move while waiting for move of type 'play'. Got move: " + JSON.stringify(a));
                    else
                        s(function() {
                            return t.play(e)
                        }, 500)
            ...
            t.bid = function(e) {
                var t = this;
                if (this.shouldMakeSubstituteMove())
                    n.prototype.bid.call(this);
                else {
                    this.waitStart || (this.waitStart = (new Date).getTime());
                    var a = this.multiplayerMoves.shift();
                    a ? (a.bid = Math.max(Math.min(a.bid, e), 0),
                    r.debug(this.name + ": Got move: " + JSON.stringify(a)),
                    delete this.waitStart,
                    "bid" === a.type ? this.game.bid(this, a.bid) : r.error(this.id + " got unexpected move while waiting for move of type 'bid'. Got move: " + JSON.stringify(a))) : s(function() {
                        return t.bid(e)
                    }, 500)
                }
            }
    ...
    24: [function(e, t, a) {
        ...
        var i = e("../shared/cardgames/render")
          ...
          , o = function(t) {
            function e() {
                var e;
                return (e = t.call(this) || this).playType = "trick",
                e
            }
            !function(e, t) {
                e.prototype = Object.create(t.prototype),
            ...
            a.win = function(e) {
                ...
                for (var i = 0, n = [0, 1]; i < n.length; i++) {
                    var r = n[i]
                      , s = t[r]
                      , o = 0 === r ? ".t1" : ".t2";
                    $("#combined-bid " + o).text(s.bid),
                    $("#tricks-taken " + o).text(s.tricks),
                    $("#bags " + o).text(s.bags),
                    $("#bags-last-round " + o).text(s.bagsPrevRound),
                    $("#bags-total " + o).text(s.totalBags),
                    $("#successful-bid " + o).text(s.tricksScore),
                    $("#failed-bid " + o).text(s.tricksPenalty),
                    $("#successful-nil-bid " + o).text(s.nilBidScore),
                    $("#failed-nil-bid " + o).text(s.nilBidPenalty),
                    $("#bag-score " + o).text(s.bagsScore),
                    $("#bag-penalty " + o).text(s.bagsPenalty),
                    $("#points-this-round " + o).text(s.score),
                    $("#points-last-round " + o).text(s.scoreLastRound),
                    $("#points-total " + o).text(s.scoreTotal)
                }
                var l = e.team1
                  , d = e.team2;
                if (0 === l.tricksScore && 0 === d.tricksScore && $("#successful-bid").hide(),
                0 === l.tricksPenalty && 0 === d.tricksPenalty && $("#failed-bid").hide(),
                0 === l.nilBidScore && 0 === d.nilBidScore && $("#successful-nil-bid").hide(),
                0 === l.nilBidPenalty && 0 === d.nilBidPenalty && $("#failed-nil-bid").hide(),
                0 === l.bagsScore && 0 === d.bagsScore && $("#bag-score").hide(),
                0 === l.bagsPenalty && 0 === d.bagsPenalty && $("#bag-penalty").hide(),
                e.gameFinished) {
                    e.game.players;
                    $("#start-new-game").hide(),
                    $("#start-new-tournament").show(),
                    $("#winner-pics").show(),
                    $("#winner1").get(0).className = $("#" + e.winner[0].id + " .face-small").get(0).className,
                    $("#winner2").get(0).className = $("#" + e.winner[1].id + " .face-small").get(0).className,
                    $("#result-header").text(e.winner[0].name + " and " + e.winner[1].name + " win the game!")
                }
                this.showResults(),
                e.callback()
            }
            ...
            a.spadesBroken = function(e) {
                e.game.message("SPADES ARE BROKEN!!! SPADES ARE BROKEN!!!"),
    ...
    25: [function(e, t, a) {
        ...
        var d = e("../shared/util")
          ...
          , y = (e("../shared/helper-functions").captainsLog,
        n);
        new (function(a) {
            function e(e) {
                var t;
                return (t = a.call(this, e) || this).roundNr = 1,
                t.tempStorage.get("autodeal") || d.qs.gid || (setTimeout(function() {
                    var e = $("html").hasClass("starwars") ? "padawan" : "partner";
                    $("#top-player-bubble p span").html('<span style="font-size:12px;margin-top:6px">Hi there ' + e + "!</span>"),
                    $("#top-player-bubble").fadeIn()
                }, 1e3),
                setTimeout(function() {
            ...
            return t.setScore = function(e, t, a, i) {
                $("#human-team-score").text(e),
                $("#human-team-bags").text(t),
                $("#computer-team-score").text(a),
                $("#computer-team-bags").text(i)
            }
            ,
            t.setupStartHandler = function() {
                var t = this;
                this.game.setEventRenderer("start", function(e) {
                    t.bindCardEventHandlers(),
                    $(".bubble").fadeOut(),
                    t.multiplayerTable && t.client.speechHandler.enable(),
                    e.callback()
                })
            }
            ,
            t.statsRegister = function(e, t, a, i) {
                t.win = t.score > a.score,
                a.win = !t.win,
                t.tournamentWin = t.scoreTotal > a.scoreTotal,
                a.tournamentWin = !t.tournamentWin,
                e[0].result = t,
                e[1].result = a,
                e[2].result = t,
                e[3].result = a;
                ...
                for (n = r ? n : n[Symbol.iterator](); ; ) {
                    ...
                    var l = o;
                    l.stats = {},
                    l.stats.result = l.result.win ? "win" : "lose",
                    i && (l.stats.tournamentResult = l.result.tournamentWin ? "win" : "lose",
                    l.stats.tournamentScore = l.result.scoreTotal),
                    l.stats.score = l.result.score,
                    l.stats.totalBagCount = l.result.bags,
                    l.stats.trickCount = l.tricks.length,
                    l.stats.teamTrickCount = l.result.tricks,
                    l.stats.teamTotalBidValue = l.result.bid,
                    l.stats.totalBidValue = l.bidValue,
                    l.stats.nilBidCount = 0 === l.bidValue ? 1 : 0,
                    l.stats.bostonCount = l.result.boston ? 1 : 0,
                    0 === l.bidValue ? 0 === l.tricks.length ? (l.stats.successNilBidCount = 1,
                    l.stats.failedNilBidCount = 0) : (l.stats.successNilBidCount = 0,
                    l.stats.failedNilBidCount = 1) : l.result.tricks >= l.result.bid ? (l.stats.successBidCount = 1,
                    l.stats.failedBidCount = 0) : (l.stats.successBidCount = 0,
                    l.stats.failedBidCount = 1)
                }
            }
            ,
            t.setupScoresFromLastRound = function() {
                ...
                var e = this.game.players
                  ...
                  , i = e[2]
                  , n = e[3];
                t.scoreLastRound = i.scoreLastRound = this.scores[0],
                t.bags = i.bags = this.scores[1],
                a.scoreLastRound = n.scoreLastRound = this.scores[2],
                a.bags = n.bags = this.scores[3]
            }
            ,
            t.setupDealHandler = function() {
                var t = this;
                $("#deal").on("click touchstart", function(e) {
                    e.preventDefault(),
                    g.startGame(),
                    $("#multiplayer-button").fadeOut(),
                    0 === t.game.players.length && (t.preloadImages(),
                    t.addPlayers()),
                    h.startGame(t.game.players),
                    t.game.message(""),
                    t.setupScoresFromLastRound(),
                    t.game.deal(),
                    $("#deal").hide(),
                    $("#open-player-picker").hide(),
                    d.trackEvent("StartGame");
                    t.started = true;
                }),
                $(document).on("keypress", function(e) {
                    if (e.keyCode === 13 && !t.started) {
                        e.preventDefault(),
                        g.startGame(),
                        $("#multiplayer-button").fadeOut(),
                        0 === t.game.players.length && (t.preloadImages(),
            ...
            ,
            t.setupMultiplayerGame = function() {
                a.prototype.setupMultiplayerGame.call(this),
                this.setupScoresFromLastRound()
            }
            ,
            t.setupMultiplayerEvents = function() {
                a.prototype.setupMultiplayerEvents.call(this),
                this.handleMultiplayerEvent("bid", function(e) {
                    return {
                        type: e.name,
                        bid: e.bid
                    }
            ...
            t.extraSetup = function() {
                var l = this;
                d.qs.fakeBoston && (this.game.fakeBoston = !0),
                this.game.setEventRenderer("startagain", function(e) {
                ...
                this.game.setEventRenderer("win", function(e) {
                    ...
                    if (l.scores = [e.team1.scoreTotal, e.team1.bagsNextRound, e.team2.scoreTotal, e.team2.bagsNextRound, l.roundNr],
                    l.tempStorage.set("scores", l.scores),
                    $(".results h5").text("Round " + l.roundNr).show(),
                    l.roundNr++,
                    l.saveLastDealer(),
                    l.setScore.apply(l, l.scores),
                    l.multiplayerTable || (d.trackEvent("Score", "Human Team", e.team1.score),
                    d.trackEvent("Score", "Computer Team", e.team2.score),
                    e.team1.score > e.team2.score ? d.trackEvent("Win", "Human Team") : d.trackEvent("Win", "Computer Team")),
                    d.trackEvent("FinishGame"),
                    g.finishGame(),
                    e.team1.boston ? (d.showConfetti(),
                    d.trackEvent("Boston", "Human Team")) : e.team2.boston && d.trackEvent("Boston", "Computer Team"),
                    l.statsRegister(e.game.players, e.team1, e.team2, e.gameFinished),
                    h.finishGame(e.game.players),
                    e.gameFinished) {
                        var s = e.winner.some(function(e) {
                            return "bottom-player" === e.id
                        }) ? "Human Team" : "Computer Team";
                        l.multiplayerTable || d.trackEvent("WinTournament", s),
                        u.makePlayersSad(e.winner.map(function(e) {
                            return e.id
                        })),
                        l.resetScores(),
                        l.roundNr = 1,
                        l.tempStorage.remove("scores"),
                        $("#inline-score").hide()
                    } else
                        e.team1.score < 0 && e.team2.score < 0 ? c([]) : e.team1.score < 0 ? c(["left-player", "right-player"]) : e.team2.score < 0 && c(["top-player", "bottom-player"]);
                ...
                this.game.setEventRenderer("startbid", function(e) {
                    if ("bottom-player" !== e.player.id || d.qs.autoplay)
                        return e.callback();
                    if (d.isMobileLookActive()) {
                        var t = y.TABLE_SIZE.height - $("#top-player").height() - y.CARD_SIZE.height - 5;
                        e.player.top !== t && l.renderer.resize(),
                        $("#bid-div").css("bottom", $("#bottom-player").height() + y.MAX_CARD_SIZE.height + 7)
                    } else
                        $("#bid-div").css("bottom", "290px");
                    ...
                    function n() {
                        e.player.doBid(parseInt($(this).text())),
                        $("#bid-div").hide(),
                        r.message("")
                    }
                    var r = l.game;
                    $("#bid-div-inner span").remove();
                    for (var s = 0; s <= e.maxBid; s++) {
                        $("<span/>").text(s).appendTo("#bid-div-inner").click(n).mouseover(a).mouseout(i);
                    }
                        document.addEventListener('keydown', function(event) {
                            if (event.keyCode === 48) {
                                e.player.doBid(0), $("#bid-div").hide(), r.message("");
                            }
                            else if (event.keyCode === 49) {
                                e.player.doBid(1), $("#bid-div").hide(), r.message("");
                            }
                            else if (event.keyCode === 50) {
                                e.player.doBid(2), $("#bid-div").hide(), r.message("");
                            }
                            else if (event.keyCode === 51) {
                                e.player.doBid(3), $("#bid-div").hide(), r.message("");
                            }
                            else if (event.keyCode === 52) {
                                e.player.doBid(4), $("#bid-div").hide(), r.message("");
                            }
                            else if (event.keyCode === 53) {
                                e.player.doBid(5), $("#bid-div").hide(), r.message("");
                            }
                            else if (event.keyCode === 54) {
                                e.player.doBid(6), $("#bid-div").hide(), r.message("");
                            }
                            else if (event.keyCode === 55) {
                                e.player.doBid(7), $("#bid-div").hide(), r.message("");
                            }
                            else if (event.keyCode === 56) {
                                e.player.doBid(8), $("#bid-div").hide(), r.message("");
                            }
                            else if (event.keyCode === 57) {
                                e.player.doBid(9), $("#bid-div").hide(), r.message("");
                            }
                ...
                $("#start-new-tournament").click(function() {
                    ...
                    l.setScore.apply(l, l.scores),
                    $("#inline-score").show(),
                    d.trackEvent("NewTournament"),
                    d.ads.trigger(function() {
                        d.qs.gid ? location.href = location.pathname : d.isMobileLookActive() ? l.game.startAgain() : d.reloadPage()
                    })
                }),
                this.scores = this.tempStorage.get("scores", [0, 0, 0, 0, 0]),
                this.setScore.apply(this, this.scores),
                $("#inline-score").show();
                this.multiplayerTable ? this.roundNr = this.multiplayerTable.round : this.roundNr = this.scores[4] + 1,
                1 === this.roundNr && d.valentines("Spades"),
                this.loadLastDealer()
            }
            ,
            t.restartWithoutReload = function() {
